 ...
 * @version $Id$
 */
public final class LanguagesByName implements Comparator
    {
    /***********************************************************************************************
    ...
    public int compare(Object obj0,
                       Object obj1)
        {
        if((obj0 instanceof LanguagePlugin) && (obj1 instanceof LanguagePlugin))
            {
            return (((LanguagePlugin)obj0).getName().compareTo(((LanguagePlugin)obj1).getName()));
            }
        else
            {
            return (0);
