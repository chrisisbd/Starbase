 ...
 */
public final class FTPException extends Exception
    {

    /**
     * Revision control id
     */
    private static final String cvsId = "@(#)$Id: FTPException.java,v 1.4 2002/11/19 22:01:25 bruceb Exp $";
     ...
     */
    public FTPException(final String msg, final String replyCode)
        {
