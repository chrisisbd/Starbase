...
/***********************************************************************************************
 * IndexedCommaSeparatedTranslator.
 */

public final class IndexedCommaSeparatedTranslator extends DataTranslator
    ...
    /***********************************************************************************************
     * Construct a IndexedCommaSeparatedTranslator.
     */

    public IndexedCommaSeparatedTranslator()
        {
    ...
    public boolean importRawData(final String filename,
        ...
        {
        final String SOURCE = "IndexedCommaSeparatedTranslator.importRawData()";
        boolean boolSuccess;
    ...
    public boolean exportXYDataset(final DAOWrapperInterface wrapper,
                                   ...
                                   final ObservatoryClockInterface clock)
        {
        final String SOURCE = "IndexedCommaSeparatedTranslator.exportXYDataset()";
        boolean boolSuccess;
    ...
    public boolean exportRawData(final DAOWrapperInterface wrapper,
                                 ...
                                 final ObservatoryClockInterface clock)
        {
        final String SOURCE = "IndexedCommaSeparatedTranslator.exportRawData()";
        boolean boolSuccess;
