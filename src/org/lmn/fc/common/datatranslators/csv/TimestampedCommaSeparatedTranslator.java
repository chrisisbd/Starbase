...
/***********************************************************************************************
 * TimestampedCommaSeparatedTranslator.
 */

public final class TimestampedCommaSeparatedTranslator extends DataTranslator
    ...
    /***********************************************************************************************
     * Construct a TimestampedCommaSeparatedTranslator.
     */

    public TimestampedCommaSeparatedTranslator()
        {
    ...
    public boolean importRawData(final String filename,
        ...
        {
        final String SOURCE = "TimestampedCommaSeparatedTranslator.importRawData()";
        boolean boolSuccess;
    ...
    public boolean exportXYDataset(final DAOWrapperInterface wrapper,
                                   ...
                                   final ObservatoryClockInterface clock)
        {
        final String SOURCE = "TimestampedCommaSeparatedTranslator.exportXYDataset()";
        boolean boolSuccess;
    ...
    public boolean exportRawData(final DAOWrapperInterface wrapper,
                                 ...
                                 final ObservatoryClockInterface clock)
        {
        final String SOURCE = "TimestampedCommaSeparatedTranslator.exportRawData()";
        boolean boolSuccess;
