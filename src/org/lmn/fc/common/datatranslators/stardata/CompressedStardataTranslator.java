...
/***************************************************************************************************
 * CompressedStardataTranslator.
 *
 * ToDo add millisec to time output
 */

public final class CompressedStardataTranslator extends DataTranslator
    ...
    /***********************************************************************************************
     * Construct a CompressedStardataTranslator.
     */

    public CompressedStardataTranslator()
        {
        super();
    ...
    public boolean importRawData(final String filename,
        ...
        {
        final String SOURCE = "CompressedStardataTranslator.importRawData()";
        boolean boolSuccess;
        ...
        if ((filename != null)
            ...
            && (filename.endsWith(DataFormat.STARDATA_COMPRESSED.getFileExtension()))
            && (eventlog != null)
            && (clock != null))
            {
            try
...
//                            }
                        ...
                        LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                                               "COMPRESSED STARDATA TRANSLATOR CHANNEL COUNT="
    ...
    public boolean exportXYDataset(final DAOWrapperInterface wrapper,
                                   ...
                                   final ObservatoryClockInterface clock)
        {
        final String SOURCE = "CompressedStardataTranslator.exportXYDataset()";
        boolean boolSuccess;
        ...
        if ((wrapper != null)
            ...
            try
                ...
                file = new File(FileUtilities.buildFullFilename(filename, timestamp, DataFormat.STARDATA_COMPRESSED));
    ...
    public boolean exportRawData(final DAOWrapperInterface wrapper,
                                 ...
                                 final ObservatoryClockInterface clock)
        {
        final String SOURCE = "CompressedStardataTranslator.exportRawData()";
        boolean boolSuccess;
    ...
    public boolean exportLog(final List<Metadata> logmetadata,
                             ...
                             final ObservatoryClockInterface clock)
        {
        final String SOURCE = "CompressedStardataTranslator.exportLog()";
        boolean boolSuccess;
    ...
    public boolean exportMetadata(final List<Metadata> metadatametadata,
                                  ...
                                  final ObservatoryClockInterface clock)
        {
        final String SOURCE = "CompressedStardataTranslator.exportMetadata()";
        boolean boolSuccess;
    ...
    public boolean exportConfiguration(final List<Metadata> configdatametadata,
                                       ...
                                       final ObservatoryClockInterface clock)
        {
        final String SOURCE = "CompressedStardataTranslator.exportConfiguration()";
        boolean boolSuccess;
...
//                                                                           parentresourcekey);
    ...
    public boolean exportReportTable(final List<Metadata> metadatametadata,
                                     ...
                                     final ObservatoryClockInterface clock)
        {
        final String SOURCE = "CompressedStardataTranslator.exportReportTable()";
        boolean boolSuccess;
