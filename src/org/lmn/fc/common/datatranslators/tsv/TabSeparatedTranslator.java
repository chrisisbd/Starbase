...
/***************************************************************************************************
 * TabSeparatedTranslator.
 */

public final class TabSeparatedTranslator extends DataTranslator
    ...
    /***********************************************************************************************
     * Construct a TabSeparatedTranslator.
     */

    public TabSeparatedTranslator()
        {
    ...
    public boolean importRawData(final String filename,
        ...
        {
        final String SOURCE = "TabSeparatedTranslator.importRawData() ";
        boolean boolSuccess;
    ...
    public boolean exportXYDataset(final DAOWrapperInterface wrapper,
                                   ...
                                   final ObservatoryClockInterface clock)
        {
        final String SOURCE = "TabSeparatedTranslator.exportXYDataset() ";
        boolean boolSuccess;
    ...
    public boolean exportRawData(final DAOWrapperInterface wrapper,
                                 ...
                                 final ObservatoryClockInterface clock)
        {
        final String SOURCE = "TabSeparatedTranslator.exportRawData() ";
        boolean boolSuccess;
    ...
    public boolean exportMetadata(final List<Metadata> metadatametadata,
        ...
        if ((metadata != null)
            ...
            try
                ...
                boolSuccess = TsvTranslatorWriters.writeMetadata(metadatametadata,
                                                                 metadata,
                                                                 false,
                                                                 outputStream,
                                                                 getMessages());
    ...
    public boolean exportReportTable(final List<Metadata> metadatametadata,
                                     ...
                                     final ObservatoryClockInterface clock)
        {
        final String SOURCE = "TabSeparatedTranslator.exportReportTable() ";
        boolean boolSuccess;
        ...
        if ((report != null)
            ...
            try
                ...
                boolSuccess = TsvTranslatorWriters.writeReportTable(metadatametadata,
                                                                    metadata,
                                                                    infercolumnmetadata,
                                                                    datasettype,
                                                                    report,
