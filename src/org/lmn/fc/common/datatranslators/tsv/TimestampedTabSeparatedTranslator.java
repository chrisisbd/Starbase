...
/***********************************************************************************************
 * TimestampedTabSeparatedTranslator.
 */

public final class TimestampedTabSeparatedTranslator extends DataTranslator
    ...
    /***********************************************************************************************
     * Construct a TimestampedTabSeparatedTranslator.
     */

    public TimestampedTabSeparatedTranslator()
        {
     ...
     * The output RawData format is: <Calendar> <Channel0> <Channel1> <Channel2> ...
     *
     * @param filename
     * @param eventlog
     * @param clock
    ...
    public boolean importRawData(final String filename,
        ...
        {
        final String SOURCE = "TimestampedTabSeparatedTranslator.importRawData()";
        boolean boolSuccess;
        ...
        if ((filename != null)
            ...
            boolSuccess = TsvTranslatorReaders.parseTabSeparatedToRawData(this,
                                                                          filename,
                                                                          // MIN_TIMESTAMPED_RAW_DATA_COLUMNS,
                                                                          eventlog,
                                                                          clock);
            }
        else
    ...
    public boolean exportXYDataset(final DAOWrapperInterface wrapper,
                                   ...
                                   final ObservatoryClockInterface clock)
        {
        final String SOURCE = "TimestampedTabSeparatedTranslator.exportXYDataset()";
        boolean boolSuccess;
    ...
    public boolean exportRawData(final DAOWrapperInterface wrapper,
                                 ...
                                 final ObservatoryClockInterface clock)
        {
        final String SOURCE = "TimestampedTabSeparatedTranslator.exportRawData()";
        boolean boolSuccess;
