...
public class FileNameParser implements DataTypeParserInterface
    {
    ...
    public static DataTypeParserInterface getInstance()
        ...
        if (PARSER_INSTANCE == null)
            {
            synchronized (FileNameParser.class)
                {
                if (PARSER_INSTANCE == null)
                    {
                    PARSER_INSTANCE = new FileNameParser();
                    }
                }
            }
    ...
    /***********************************************************************************************
     * Privately construct the FileNameParser.
     */
