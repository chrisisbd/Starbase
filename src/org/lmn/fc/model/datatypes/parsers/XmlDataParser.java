...
public class XmlDataParser implements DataTypeParserInterface
    {
    ...
    public static DataTypeParserInterface getInstance()
        ...
        if (PARSER_INSTANCE == null)
            {
            synchronized (XmlDataParser.class)
                {
                if (PARSER_INSTANCE == null)
                    {
                    PARSER_INSTANCE = new XmlDataParser();
                    }
                }
            }
    ...
    /***********************************************************************************************
     * Privately construct the XmlDataParser.
     */
     ...
     * I am not sure how this might work for XML, since the XML would have to be *inside* the XML
        ...
        if ((parameter.getRegex() != null)
            ...
            if (Pattern.matches(parameter.getRegex(), parameter.getValue()))
                ...
                try
                    ...
                    xmlObject = XmlObject.Factory.parse(parameter.getValue());

                    if ((XmlBeansUtilities.isValidXml(xmlObject)))
                        {
                        // Accept the value
                        }
                    else
                ...
                {
                errors.add("[name=" + parameter.getName() + "]" + INVALID_XML);
                errors.add("[name=" + parameter.getName() + "]" + MSG_REGEX + parameter.getRegex());
                intFailures++;
                }
            }
        ...
        if ((datatype.getRegex() != null)
            ...
            if (Pattern.matches(datatype.getRegex(), valuefield))
                ...
                try
                    ...
                    xmlObject = XmlObject.Factory.parse(valuefield);
                ...
                {
                errors.add("[" + valuefield + "]" + INVALID_XML);
                errors.add("[" + valuefield + "]" + MSG_REGEX + datatype.getRegex());
                intFailures++;
                }
            }
    ...
    public boolean parseBytesToResponseValue(final byte[] bytes,
        ...
        if ((responsetype.getRegex() != null)
            ...
            if (Pattern.matches(responsetype.getRegex(), valuefield))
                ...
                {
                errors.add("[name=" + responsetype.getName() + "]" + INVALID_XML);
                errors.add("[name=" + responsetype.getName() + "]" + MSG_REGEX + responsetype.getRegex());
                intFailures++;
                }
            }
