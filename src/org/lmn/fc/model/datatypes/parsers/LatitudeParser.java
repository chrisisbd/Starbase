...
public class LatitudeParser implements DataTypeParserInterface
    {
    ...
    public static DataTypeParserInterface getInstance()
        ...
        if (PARSER_INSTANCE == null)
            {
            synchronized (LatitudeParser.class)
                {
                if (PARSER_INSTANCE == null)
                    {
                    PARSER_INSTANCE = new LatitudeParser();
                    }
                }
            }
    ...
    /***********************************************************************************************
     * Privately construct the LatitudeParser.
     */

    private LatitudeParser()
        {
