...
public class PathNameParser implements DataTypeParserInterface
    {
    ...
    public static DataTypeParserInterface getInstance()
        ...
        if (PARSER_INSTANCE == null)
            {
            synchronized (PathNameParser.class)
                {
                if (PARSER_INSTANCE == null)
                    {
                    PARSER_INSTANCE = new PathNameParser();
                    }
                }
            }
    ...
    /***********************************************************************************************
     * Privately construct the PathNameParser.
     */

    private PathNameParser()
        {
        super();
        }
    ...
    public boolean validateParameterValueAsDataType(final ParameterType parameter,
        ...
        {
        return (DataTypeDictionary.STRING.getParser().validateParameterValueAsDataType(parameter, datatype, errors));
        }
    ...
    public boolean validateValueFieldAsDataType(final String valuefield,
                                                ...
                                                final List<String> errors)
        {
        return (DataTypeDictionary.STRING.getParser().validateValueFieldAsDataType(valuefield, datatype, errors));
        }
    ...
    public RootDataTypeInterface parseValueFieldToDataType(final String valuefield,
                                                           ...
                                                           final List<String> errors)
        {
        return (DataTypeDictionary.STRING.getParser().parseValueFieldToDataType(valuefield, datatype, name, regex, errors));
        }
    ...
    public Number parseValueFieldToNumber(final String valuefield,
                                          ...
                                          final List<String> errors)
        {
        return (DataTypeDictionary.STRING.getParser().parseValueFieldToNumber(valuefield, datatype, name, regex, errors));
        }
    ...
    public boolean parseBytesToResponseValue(final byte[] bytes,
                                             ...
                                             final List<String> errors)
        {
        return (DataTypeDictionary.STRING.getParser().parseBytesToResponseValue(bytes, datatype, responsetype, errors));
        }
    }
