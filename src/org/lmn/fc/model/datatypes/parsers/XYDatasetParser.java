...
public class XYDatasetParser implements DataTypeParserInterface
    {
    ...
    public static DataTypeParserInterface getInstance()
        ...
        if (PARSER_INSTANCE == null)
            {
            synchronized (XYDatasetParser.class)
                {
                if (PARSER_INSTANCE == null)
                    {
                    PARSER_INSTANCE = new XYDatasetParser();
                    }
                }
            }
    ...
    /***********************************************************************************************
     * Privately construct the XYDatasetParser.
     */

    private XYDatasetParser()
        {
        super();
        }
