...
public class ElevationParser implements DataTypeParserInterface
    {
    ...
    public static DataTypeParserInterface getInstance()
        ...
        if (PARSER_INSTANCE == null)
            {
            synchronized (ElevationParser.class)
                {
                if (PARSER_INSTANCE == null)
                    {
                    PARSER_INSTANCE = new ElevationParser();
                    }
                }
            }
    ...
    /***********************************************************************************************
     * Privately construct the ElevationParser.
     */

    private ElevationParser()
        {
