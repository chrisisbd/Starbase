...
public class AzimuthParser implements DataTypeParserInterface
    {
    ...
    public static DataTypeParserInterface getInstance()
        ...
        if (PARSER_INSTANCE == null)
            {
            synchronized (AzimuthParser.class)
                {
                if (PARSER_INSTANCE == null)
                    {
                    PARSER_INSTANCE = new AzimuthParser();
                    }
                }
            }
    ...
    /***********************************************************************************************
     * Privately construct the AzimuthParser.
     */

    private AzimuthParser()
        {
