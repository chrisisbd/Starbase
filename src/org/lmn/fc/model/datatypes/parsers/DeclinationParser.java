...
public class DeclinationParser implements DataTypeParserInterface
    {
    ...
    public static DataTypeParserInterface getInstance()
        ...
        if (PARSER_INSTANCE == null)
            {
            synchronized (DeclinationParser.class)
                {
                if (PARSER_INSTANCE == null)
                    {
                    PARSER_INSTANCE = new DeclinationParser();
                    }
                }
            }
    ...
    /***********************************************************************************************
     * Privately construct the DeclinationParser.
     */

    private DeclinationParser()
        {
