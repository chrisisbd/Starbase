...
import org.lmn.fc.model.datatypes.types.AngleDataType;
...
public class AngleParser implements DataTypeParserInterface
    {
    ...
    public static DataTypeParserInterface getInstance()
        ...
        if (PARSER_INSTANCE == null)
            {
            synchronized (AngleParser.class)
                {
                if (PARSER_INSTANCE == null)
                    {
                    PARSER_INSTANCE = new AngleParser();
                    }
                }
            }
    ...
    /***********************************************************************************************
     * Privately construct the AngleParser.
     */
    ...
    public boolean validateParameterValueAsDataType(final ParameterType parameter,
        ...
        if ((parameter.getRegex() != null)
            ...
            if (Pattern.matches(parameter.getRegex(), parameter.getValue()))
                ...
                {
                errors.add("[name=" + parameter.getName() + "]" + INVALID_ANGLE);
    ...
    public boolean validateValueFieldAsDataType(final String valuefield,
        ...
        if ((datatype.getRegex() != null)
            ...
            if (Pattern.matches(datatype.getRegex(), valuefield))
                ...
                {
                errors.add("[" + valuefield + "]" + INVALID_ANGLE);
        ...
        if ((valuefield != null)
            ...
            if ((datatype.getRegex() != null)
                ...
                if (Pattern.matches(datatype.getRegex(), valuefield))
                    ...
                    try
                        {
                        // Angle is just a wrapper for Double
                        dataTypeInterface = new AngleDataType(Double.parseDouble(valuefield));
                        }
        ...
        if ((valuefield != null)
            ...
            if ((datatype.getRegex() != null)
                ...
                if (Pattern.matches(datatype.getRegex(), valuefield))
                    ...
                    try
                        {
                        number = Double.parseDouble(valuefield);
                        }
    ...
    public boolean parseBytesToResponseValue(final byte[] bytes,
        ...
        if ((responsetype.getRegex() != null)
            ...
            if (Pattern.matches(responsetype.getRegex(), valuefield))
                ...
                {
                errors.add("[name=" + responsetype.getName() + "]" + INVALID_ANGLE);
