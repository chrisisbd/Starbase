...
public class MetadataKeyParser implements DataTypeParserInterface
    {
    ...
    public static DataTypeParserInterface getInstance()
        ...
        if (PARSER_INSTANCE == null)
            {
            synchronized (MetadataKeyParser.class)
                {
                if (PARSER_INSTANCE == null)
                    {
                    PARSER_INSTANCE = new MetadataKeyParser();
                    }
                }
            }
    ...
    /***********************************************************************************************
     * Privately construct the MetadataKeyParser.
     */

    private MetadataKeyParser()
        {
        super();
        }
    ...
    public boolean validateParameterValueAsDataType(final ParameterType parameter,
        ...
        if ((parameter.getRegex() != null)
            ...
            if (Pattern.matches(parameter.getRegex(), parameter.getValue()))
                ...
                {
                errors.add("[name=" + parameter.getName() + "]" + INVALID_METADATA_KEY);
            ...
            if ((parameter.getValue() == null)
                ...
                {
                errors.add(parameter.getValue() + INVALID_METADATA_KEY);
                intFailures++;
                }
            }
    ...
    public boolean validateValueFieldAsDataType(final String valuefield,
        ...
        if ((datatype.getRegex() != null)
            ...
            if (Pattern.matches(datatype.getRegex(), valuefield))
                ...
                {
                errors.add("[" + valuefield + "]" + INVALID_STRING);
                intFailures++;
                }
            }
        else
            ...
            if ((valuefield == null)
                ...
                {
                errors.add("[" + valuefield + "]" + INVALID_METADATA_KEY);
                intFailures++;
                }
            }
