...
/***************************************************************************************************
 * RightAscensionParser.
 */

public class RightAscensionParser implements DataTypeParserInterface
    {
    ...
    public static DataTypeParserInterface getInstance()
        ...
        if (PARSER_INSTANCE == null)
            {
            synchronized (RightAscensionParser.class)
                {
                if (PARSER_INSTANCE == null)
                    {
                    PARSER_INSTANCE = new RightAscensionParser();
                    }
                }
            }
    ...
    /***********************************************************************************************
     * Privately construct the RightAscensionParser.
     */

    private RightAscensionParser()
        {
        // Decorate the Root Parser
        parser = HourMinSecParser.getInstance();
        }
