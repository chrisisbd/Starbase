...
public class SignedHexByteParser implements DataTypeParserInterface
    {
    ...
    public static DataTypeParserInterface getInstance()
        ...
        if (PARSER_INSTANCE == null)
            {
            synchronized (SignedHexByteParser.class)
                {
                if (PARSER_INSTANCE == null)
                    {
                    PARSER_INSTANCE = new SignedHexByteParser();
                    }
                }
            }
    ...
    /***********************************************************************************************
     * Privately construct the SignedHexByteParser.
     */

    private SignedHexByteParser()
        {
        super();
        }
            ...
            if (Pattern.matches(parameter.getRegex(), valuefield))
                ...
                try
                    ...
                    if ((valuefield.length() > 1)
                        ...
                        {
                        Byte.parseByte(valuefield.substring(1), datatype.getRadix());
                        }
                    else
                        {
                        Byte.parseByte(valuefield, datatype.getRadix());
                        }
                    }
