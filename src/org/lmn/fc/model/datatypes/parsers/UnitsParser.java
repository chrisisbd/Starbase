...
public class UnitsParser implements DataTypeParserInterface
    {
    ...
    public static DataTypeParserInterface getInstance()
        ...
        if (PARSER_INSTANCE == null)
            {
            synchronized (UnitsParser.class)
                {
                if (PARSER_INSTANCE == null)
                    {
                    PARSER_INSTANCE = new UnitsParser();
                    }
                }
            }
    ...
    /***********************************************************************************************
     * Privately construct the UnitsParser.
     */
    ...
    public boolean validateParameterValueAsDataType(final ParameterType parameter,
        ...
        // The value of the Parameter must be one of the Units known in the SchemaUnits enumeration
        if (SchemaUnits.Enum.forString(parameter.getValue()) == null)
            {
            errors.add(parameter.getValue() + INVALID_UNITS);
            intFailures++;
            }
    ...
    public boolean validateValueFieldAsDataType(final String valuefield,
        ...
        // The value of the Field must be one of the Units known in the SchemaUnits enumeration
        if (SchemaUnits.Enum.forString(valuefield) == null)
            {
            errors.add("[" + valuefield + "]" + INVALID_UNITS);
            intFailures++;
            }
