...
public class BooleanParser implements DataTypeParserInterface
    {
    ...
    public static DataTypeParserInterface getInstance()
        ...
        if (PARSER_INSTANCE == null)
            ...
            synchronized (BooleanParser.class)
                ...
                if (PARSER_INSTANCE == null)
                    {
                    PARSER_INSTANCE = new BooleanParser();
                    }
                }
            }
    ...
    /***********************************************************************************************
     * Privately construct the BooleanParser.
     */
        ...
        if ((parameter.getRegex() != null)
            ...
            if (Pattern.matches(parameter.getRegex(), parameter.getValue()))
                ...
                try
                    ...
                    // Booleans are the only case where the contents of ParameterValue are changed
                    // This is to normalise the true/false representation
                    parameter.setValue(Boolean.toString(boolValue));
                    }
                ...
                {
                errors.add("[name=" + parameter.getName() + "]" + INVALID_BOOLEAN);
    ...
    public boolean validateValueFieldAsDataType(final String valuefield,
        ...
        if ((datatype.getRegex() != null)
            ...
            if (Pattern.matches(datatype.getRegex(), valuefield))
                ...
                try
                    {
                    Boolean.parseBoolean(valuefield);
                    }
                ...
                {
                errors.add("[" + valuefield + "]" + INVALID_BOOLEAN);
        ...
        if ((responsetype.getRegex() != null)
            ...
            if (Pattern.matches(responsetype.getRegex(), valuefield))
                ...
                try
                    ...
                    // The <code>boolean</code> returned represents the value true
                    // if the string argument is not null and is equal, ignoring case,
                    // to the string "true"
                    boolValue = Boolean.parseBoolean(valuefield);
                    responsetype.setValue(Boolean.toString(boolValue));
                    }
                ...
                {
                errors.add("[name=" + responsetype.getName() + "]" + INVALID_BOOLEAN);
