...
/***************************************************************************************************
 * UnsignedLongitudeParser.
 */

public class UnsignedLongitudeParser implements DataTypeParserInterface
    {
    ...
    public static DataTypeParserInterface getInstance()
        ...
        if (PARSER_INSTANCE == null)
            {
            synchronized (UnsignedLongitudeParser.class)
                {
                if (PARSER_INSTANCE == null)
                    {
                    PARSER_INSTANCE = new UnsignedLongitudeParser();
                    }
                }
            }
    ...
    /***********************************************************************************************
     * Privately construct the UnsignedLongitudeParser.
     */

    private UnsignedLongitudeParser()
        {
