...
/***************************************************************************************************
 * SignedDecimalByteParser.
 */

public class SignedDecimalByteParser implements DataTypeParserInterface
    {
    ...
    public static DataTypeParserInterface getInstance()
        ...
        if (PARSER_INSTANCE == null)
            {
            synchronized (SignedDecimalByteParser.class)
                {
                if (PARSER_INSTANCE == null)
                    {
                    PARSER_INSTANCE = new SignedDecimalByteParser();
                    }
                }
            }
    ...
    /***********************************************************************************************
     * Privately construct the SignedDecimalByteParser.
     */

    private SignedDecimalByteParser()
        {
        super();
        }
