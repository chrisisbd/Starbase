//--------------------------------------------------------------------------------------------------
// NullData for tree nodes
//--------------------------------------------------------------------------------------------------
// Revision History
//
//  30-01-00    LMN created file
//  15-04-03    LMN added Icon to constructor
//  19-04-03    LMN added link back to host DefaultMutableTreeNode
//  25-04-03    LMN added getUIComponent()
//  27-04-03    LMN added setUIComponent() and getUIComponent()
//  23-05-03    LMN added getPathname() to solve caption problem in FrameworkManager
//  27-06-03    LMN fixed getPathname() for null parameters
//  17-11-04    LMN added GradientPaint, removed getCanvas()
//
//--------------------------------------------------------------------------------------------------
...
public final class NullData extends AtomData
                            implements AtomPlugin
    {
    private static final long VERSION_ID = -1281155719308595010L;
    ...
    /***********************************************************************************************
     * NullData is a placeholder for selections.
     */
    ...
    public NullData()
        ...
        // Create a default panel from the Framework instance UIComponent
        setUIComponent(REGISTRY_MODEL.getFramework().getUIComponent());
        }
...
//    public NullData(final String pathname,
//                    final String name,
//                    final String icon,
...
//        setUIComponent(new BlankUIComponent("NULL DATA 0"));
//        }
...
//
//        // Create a default panel
//        setUIComponent(new BlankUIComponent("NULL DATA 1"));
//        }
