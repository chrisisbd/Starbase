...
/***************************************************************************************************
 * The RolesDAOInterface.
 */

public interface RolesDAOInterface extends FrameworkConstants,
                                           FrameworkStrings,
                                           FrameworkMetadata,
    ResourceKeys
    {
    String ROLES_XML = "/roles.xml";

    Logger LOGGER = Logger.getInstance();
    RegistryPlugin REGISTRY = Registry.getInstance();


    void importRoles() throws FrameworkException;

    void exportRoles() throws FrameworkException;
    }
