...
/***************************************************************************************************
 * The LookAndFeelsDAOInterface.
 */

public interface LookAndFeelsDAOInterface extends FrameworkConstants,
                                                  FrameworkStrings,
                                                  FrameworkMetadata,
    ResourceKeys
    {
    String LOOKANDFEELS_XML = "/lookandfeels.xml";

    Logger LOGGER = Logger.getInstance();
    RegistryPlugin REGISTRY = Registry.getInstance();


    void importLookAndFeels() throws FrameworkException;

    void exportLookAndFeels(boolean debug) throws FrameworkException;
    }
