...
/***************************************************************************************************
 * The ResourcesDAOInterface.
 */

public interface ResourcesDAOInterface extends FrameworkConstants,
                                               FrameworkStrings,
                                               FrameworkMetadata,
    ResourceKeys
    {
    ...
    void importResources() throws FrameworkException;

    void exportResources() throws FrameworkException;
    }
