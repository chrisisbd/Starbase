...
/***************************************************************************************************
 * The PluginsDAOInterface.
 */

public interface PluginsDAOInterface extends FrameworkConstants,
                                             FrameworkStrings,
                                             FrameworkMetadata,
                                             ResourceKeys
    {
    // XML Persistence Filename
    String PLUGINS_XML = "/plugins.xml";

    Logger LOGGER = Logger.getInstance();
    RegistryPlugin REGISTRY = Registry.getInstance();

    void importPlugins(AtomPlugin host,
                       String folder,
                       String language) throws FrameworkException;

    void exportPlugins() throws FrameworkException;
    }
