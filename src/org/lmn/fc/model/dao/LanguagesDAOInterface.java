...
public interface LanguagesDAOInterface extends FrameworkConstants,
                                               FrameworkStrings,
                                               FrameworkMetadata,
    ResourceKeys
    {
    String LANGUAGES_XML = "/languages.xml";

    Logger LOGGER = Logger.getInstance();
    RegistryPlugin REGISTRY = Registry.getInstance();

    // Languages Table Columns
    String LANGUAGE_ISOCODE        = "LanguageCode";
    String LANGUAGE_INSTALLED      = "LanguageInstalled";
    String LANGUAGE_NAME           = "LanguageName";

    // Queries
    String SELECT_LANGUAGE_LIST = "Select.Language.List";
    int FIELDSIZE_ISO_CODE_2 = 2;

    void importLanguages() throws FrameworkException;

    void exportLanguages() throws FrameworkException;
    }
