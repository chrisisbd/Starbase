...
/***************************************************************************************************
 * The TasksDAOInterface.
 */

public interface TasksDAOInterface extends FrameworkConstants,
                                           FrameworkStrings,
                                           FrameworkMetadata,
                                           ResourceKeys
    {
    ...
    void importTasks() throws FrameworkException;

    void exportTasks() throws FrameworkException;
    }
