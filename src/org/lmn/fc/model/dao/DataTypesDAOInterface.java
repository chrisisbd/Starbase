...
public interface DataTypesDAOInterface extends FrameworkConstants,
                                               FrameworkStrings,
                                               FrameworkMetadata,
                                               ResourceKeys
    {
    ...
    String DATATYPES_XML = "/datatypes.xml";

    // Queries
    String SELECT_DATATYPE_LIST    = "Select.DataType.List";

    void importDataTypes() throws FrameworkException;

    void exportDataTypes() throws FrameworkException;
    }
