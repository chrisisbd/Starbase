...
/***************************************************************************************************
 * The FrameworkDAOInterface.
 */

public interface FrameworkDAOInterface extends FrameworkConstants,
                                               FrameworkStrings,
                                               FrameworkMetadata,
                                               ResourceKeys
    {
    // XML Persistence Filename
    String FRAMEWORKS_XML = "/frameworks.xml";

    Logger LOGGER = Logger.getInstance();
    RegistryPlugin REGISTRY = Registry.getInstance();

    void importFramework() throws FrameworkException;

    void exportFramework() throws FrameworkException;
    }
