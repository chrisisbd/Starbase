...
package org.lmn.fc.frameworks.starbase.events;
...
/***********************************************************************************************
 * FrameworkChangedEvent.
 */

public final class FrameworkChangedEvent extends EventObject
    {
    private final FrameworkPlugin pluginFramework;


    /***********************************************************************************************
     * Construct a FrameworkChangedEvent.
     *
     * @param eventsource
     * @param framework
     */

    public FrameworkChangedEvent(final Object eventsource,
