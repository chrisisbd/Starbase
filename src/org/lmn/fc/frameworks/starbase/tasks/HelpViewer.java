...
//  16-10-04    LMN converting for runUI() and stopUI()
//
//--------------------------------------------------------------------------------------------------
...
/***************************************************************************************************
 * The Framework HelpViewer.
 */

public final class HelpViewer extends TaskData
    {
    /***********************************************************************************************
     * Construct a HelpViewer for the Framework.
     */

    private HelpViewer()
        {
        super(-4940354032816105442L, REGISTRY.getFramework());
        }
    ...
    public final boolean runTask()
        ...
        // Create a HelpViewer specifically for this Framework
        LOGGER.debugNavigation("HelpViewer URL=" + RegistryModelUtilities.getHelpURL(REGISTRY.getFramework()));

        setUIComponent(new HTMLPanel(RegistryModelUtilities.getHelpURL(REGISTRY.getFramework())));
    ...
    public final void runUI()
        ...
        setStatus(STATUS_HELP + SPACE + REGISTRY.getFramework().getName());
        }
