...
// Revision History
//
//  09-06-03    LMN created file
//  15-10-03    LMN converting for FrameworkEvents
//  20-10-03    LMN converting to use ContextActions for MenuBar and ToolBar
//  05-05-04    LMN changed to EventReport
//  16-10-04    LMN converted for runUI() and stopUI()
//
//--------------------------------------------------------------------------------------------------
...
/***************************************************************************************************
 * An EventViewer for Framework Tasks.
 */

public final class EventViewer extends TaskData
    {
    /***********************************************************************************************
     * Construct a Framework EventViewer.
     */

    private EventViewer()
        {
        super(-7607306612425923166L, REGISTRY.getFramework());
        }
    ...
    public final void runUI()
        ...
        setStatus(STATUS_EVENTS + SPACE + REGISTRY.getFramework().getName());
        }
