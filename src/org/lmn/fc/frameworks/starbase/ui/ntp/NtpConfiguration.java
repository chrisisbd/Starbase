...
/***************************************************************************************************
 * The NTP ConfigurationReport.
 */

public final class NtpConfiguration extends ReportTable
    ...
    /***********************************************************************************************
     * Construct an NtpConfiguration JTable for the specified Task.
    ...
    public NtpConfiguration(final RootPlugin task,
    ...
    public final Vector<Vector> generateReport()
        ...
        vecRow.add(KEY_NTP_SERVER_DEFAULT);
        vecRow.add(REGISTRY.getStringProperty(key + KEY_NTP_SERVER_DEFAULT));
        vecReport.add(vecRow);

        vecRow = new Vector<Object>(2);
        vecRow.add(KEY_NTP_SERVER_1);
        vecRow.add(REGISTRY.getStringProperty(key + KEY_NTP_SERVER_1));
        vecReport.add(vecRow);

        vecRow = new Vector<Object>(2);
        vecRow.add(KEY_NTP_SERVER_2);
        vecRow.add(REGISTRY.getStringProperty(key + KEY_NTP_SERVER_2));
        vecReport.add(vecRow);

        vecRow = new Vector<Object>(2);
        vecRow.add(KEY_NTP_SERVER_3);
        vecRow.add(REGISTRY.getStringProperty(key + KEY_NTP_SERVER_3));
        vecReport.add(vecRow);

        vecRow = new Vector<Object>(2);
        vecRow.add(KEY_NTP_ENABLE_NTP);
        vecRow.add(REGISTRY.getBooleanProperty(key + KEY_NTP_ENABLE_NTP));
        vecReport.add(vecRow);

        vecRow = new Vector<Object>(2);
        vecRow.add(KEY_NTP_ENABLE_SET_TIME);
        vecRow.add(REGISTRY.getBooleanProperty(key + KEY_NTP_ENABLE_SET_TIME));
        vecReport.add(vecRow);

        vecRow = new Vector<Object>(2);
        vecRow.add(KEY_NTP_ENABLE_TRACE);
        vecRow.add(REGISTRY.getBooleanProperty(key + KEY_NTP_ENABLE_TRACE));
        vecReport.add(vecRow);

        vecRow = new Vector<Object>(2);
        vecRow.add(KEY_NTP_PERIOD_UPDATE);
        vecRow.add(REGISTRY.getIntegerProperty(key + KEY_NTP_PERIOD_UPDATE));
        vecReport.add(vecRow);
