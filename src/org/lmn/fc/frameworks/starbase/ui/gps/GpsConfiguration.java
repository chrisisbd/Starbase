...
/***************************************************************************************************
 * The GPS ConfigurationReport.
 */

public final class GpsConfiguration extends ReportTable
    ...
    /***********************************************************************************************
     * Construct an GpsConfiguration JTable for the specified Task.
    ...
    public GpsConfiguration(final RootPlugin task,
    ...
    public final Vector<Vector> generateReport()
        ...
        vecRow.add(KEY_GPS_RECEIVER_TYPE);
        vecRow.add(REGISTRY.getStringProperty(key + KEY_GPS_RECEIVER_TYPE));
        vecReport.add(vecRow);

        vecRow = new Vector<Object>(2);
        vecRow.add(KEY_GPS_RECEIVER_CLASS_NAME);
        vecRow.add(REGISTRY.getStringProperty(key + KEY_GPS_RECEIVER_CLASS_NAME));
        vecReport.add(vecRow);
        ...
        vecRow = new Vector<Object>(2);
        vecRow.add(KEY_GPS_PERIOD_UPDATE);
        vecRow.add(REGISTRY.getIntegerProperty(key + KEY_GPS_PERIOD_UPDATE));
        vecReport.add(vecRow);

        vecRow = new Vector<Object>(2);
        vecRow.add(KEY_GPS_PERIOD_CAPTURE);
        vecRow.add(REGISTRY.getIntegerProperty(key + KEY_GPS_PERIOD_CAPTURE));
        vecReport.add(vecRow);

        vecRow = new Vector<Object>(2);
        vecRow.add(KEY_GPS_ENABLE_GPS_RECEIVER);
        vecRow.add(REGISTRY.getBooleanProperty(key + KEY_GPS_ENABLE_GPS_RECEIVER));
        vecReport.add(vecRow);
