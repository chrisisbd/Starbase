...
package org.lmn.fc.frameworks.starbase.plugins.observatory.ui.instruments.impl.starinetlogger.dao;
...
public class StarinetLoggerDAO extends StaribusCoreDAO
    ...
    public StarinetLoggerDAO(final ObservatoryInstrumentInterface hostinstrument)
        {
    ...
    public boolean initialiseDAO(final String resourcekey)
        {
        final String SOURCE = "StarinetLoggerDAO.initialiseDAO() ";
    ...
    public ResponseMessageInterface captureRawDataRealtime(final CommandMessageInterface commandmessage)
        {
        final String SOURCE = "StarinetLoggerDAO.captureRawDataRealtime()";
    ...
    public ResponseMessageInterface publishChartRealtime(final CommandMessageInterface commandmessage)
        {
        final String SOURCE = "StarinetLoggerDAO.publishChartRealtime() ";
    ...
    public ResponseMessageInterface publishChartRealtimeDay(final CommandMessageInterface commandmessage)
        {
        final String SOURCE = "StarinetLoggerDAO.publishChartRealtimeDay() ";
    ...
    public ResponseMessageInterface getStarinetAddress(final CommandMessageInterface commandmessage)
        {
        final String SOURCE = "StarinetLoggerDAO.getStarinetAddress() ";
    ...
    public ResponseMessageInterface writeCommandMap(final CommandMessageInterface commandmessage)
        {
        final String SOURCE = "StarinetLoggerDAO.writeCommandMap() ";
    ...
    public void readResources()
        {
        final String SOURCE = "StarinetLoggerDAO.readResources() ";
