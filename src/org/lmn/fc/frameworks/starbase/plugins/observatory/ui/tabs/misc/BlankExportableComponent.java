...
/***************************************************************************************************
 * BlankExportableComponent.
 */

public class BlankExportableComponent implements ExportableComponentInterface
    {
    /***********************************************************************************************
    ...
    public int getWidth()
        {
        LOGGER.error("BlankExportableComponent.getWidth() should never be called!");
        return (0);
        }
    ...
    public int getHeight()
        {
        LOGGER.error("BlankExportableComponent.getHeight() should never be called!");
        return (0);
        }
    ...
    public void paintForExport(final Graphics2D graphics,
                               ...
                               final int height)
        {
        LOGGER.error("BlankExportableComponent.paintForExport() should never be called!");
        }
    }
