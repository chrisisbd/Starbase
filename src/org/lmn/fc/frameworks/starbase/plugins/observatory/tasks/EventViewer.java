...
package org.lmn.fc.frameworks.starbase.plugins.observatory.tasks;
...
/***************************************************************************************************
 * An EventViewer for Observatory Tasks.
 */

public final class EventViewer extends TaskData
    {
    /***********************************************************************************************
     * Construct an Observatory EventViewer.
     */

    private EventViewer()
        {
        super(-2225014270612969271L, REGISTRY.getFramework());
        }
