...
/***************************************************************************************************
 * The TemplateControlPanel.
 */

public final class TemplateControlPanel extends InstrumentUIComponentDecorator
                                        implements ControlPanelInterface
    {
    // String Resources
    private static final String ICON_CONTROL = "template-control.png";


    /***********************************************************************************************
     * Construct the TemplateControlPanel.
     *
     * @param instrument
     * @param instrumentxml
     * @param hostui
    ...
    public TemplateControlPanel(final ObservatoryInstrumentInterface instrument,
    ...
    public void instrumentChanged(final InstrumentStateChangedEvent event)
        {
        LOGGER.debugIndicators("TemplateControlPanel.instrumentChanged() --> update indicators");
