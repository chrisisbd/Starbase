...
/***************************************************************************************************
 * The SamMagnetometerControlPanel.
 */

public final class SamMagnetometerControlPanel extends InstrumentUIComponentDecorator
                                               implements ControlPanelInterface
    {
    // String Resources
    private static final String ICON_CONTROL = "magnetometer-sam-control.png";
    private static final String DEFAULT_DATA_FORMAT_0 = "+0000";
    private static final String DEFAULT_DATA_FORMAT_1 = "+0000";


    /***********************************************************************************************
     * Construct the SamMagnetometerControlPanel.
     *
     * @param instrument
     * @param instrumentxml
     * @param hostui
    ...
    public SamMagnetometerControlPanel(final ObservatoryInstrumentInterface instrument,
    ...
    public void instrumentChanged(final InstrumentStateChangedEvent event)
        {
        LOGGER.debugIndicators("SamMagnetometerControlPanel.instrumentChanged() --> update indicators");
