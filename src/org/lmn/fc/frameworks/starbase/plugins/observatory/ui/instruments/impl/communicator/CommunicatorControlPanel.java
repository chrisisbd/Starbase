...
/***************************************************************************************************
 * The CommunicatorControlPanel.
 */

public final class CommunicatorControlPanel extends InstrumentUIComponentDecorator
                                            implements ControlPanelInterface
    {
    // String Resources
    private static final String ICON_CONTROL = "communicator-control.png";


    /***********************************************************************************************
     * Construct the CommunicatorControlPanel.
     *
     * @param instrument
     * @param instrumentxml
     * @param hostui
    ...
    public CommunicatorControlPanel(final ObservatoryInstrumentInterface instrument,
    ...
    public void instrumentChanged(final InstrumentStateChangedEvent event)
        {
        LOGGER.debugIndicators("CommunicatorControlPanel.instrumentChanged() --> update indicators");
