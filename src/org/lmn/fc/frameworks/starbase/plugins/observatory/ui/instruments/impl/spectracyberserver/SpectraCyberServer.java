...
/***********************************************************************************************
 * A SpectraCyberServer.
 */

public final class SpectraCyberServer extends AbstractObservatoryInstrument
                                      implements ObservatoryInstrumentInterface
    {
    /***********************************************************************************************
     * Construct a SpectraCyberServer.
     *
     * @param instrument
     * @param plugin
     * @param hostui
    ...
    public SpectraCyberServer(final Instrument instrument,
    ...
    /***********************************************************************************************
     * Initialise the SpectraCyberServer.
     */
    ...
    public void initialise()
        ...
        // Read the Resources for the SpectraCyberServer
        readResources();

        super.initialise();

        // Create and initialise the ControlPanel
        controlPanel = new SpectraCyberServerControlPanel(this,
                                                          getInstrument(),
                                                          getHostUI(),
        ...
        instrumentPanel = new SpectraCyberServerInstrumentPanel(this,
                                                                getInstrument(),
                                                                getHostUI(),
                                                                (TaskPlugin)getHostAtom().getRootTask(),
                                                                getFontData(),
    ...
    /* Utilities                                                                                  */
    /***********************************************************************************************
     *  Read all the Resources required by the SpectraCyberServer.
     */

    public void readResources()
        {
        LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                               "SpectraCyberServer [ResourceKey=" + getResourceKey() + "]");
