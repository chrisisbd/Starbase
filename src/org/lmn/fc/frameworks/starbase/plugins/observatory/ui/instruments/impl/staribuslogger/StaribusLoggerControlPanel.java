...
/***************************************************************************************************
 * The StaribusLoggerControlPanel.
 */

public final class StaribusLoggerControlPanel extends InstrumentUIComponentDecorator
                                              implements ControlPanelInterface
    {
    // String Resources
    private static final String ICON_CONTROL = "staribus-logger-control.png";
    private static final String DEFAULT_FORMAT = "0000 mV";


    /***********************************************************************************************
     * Construct the StaribusLoggerControlPanel.
     *
     * @param instrument
     * @param instrumentxml
     * @param obsui
    ...
    public StaribusLoggerControlPanel(final ObservatoryInstrumentInterface instrument,
    ...
    public void instrumentChanged(final InstrumentStateChangedEvent event)
        {
        final String SOURCE = "StaribusLoggerControlPanel.instrumentChanged() ";

        super.instrumentChanged(event);

        // Update the Indicators using the real Metadata if possible, defaults if not
        // The ControlPanel is always showing, the Instrument does not have to be selected
