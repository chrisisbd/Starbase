...
public final class StarinetPythonLogger extends AbstractObservatoryInstrument
    ...
    public StarinetPythonLogger(final Instrument instrument,
    ...
    public void initialise()
        ...
        controlPanel = new StarinetPythonLoggerControlPanel(this,
                                                      getInstrument(),
                                                      getHostUI(),
        ...
        instrumentPanel = new StarinetPythonLoggerInstrumentPanel(this,
                                                            getInstrument(),
                                                            getHostUI(),
                                                            (TaskPlugin)getHostAtom().getRootTask(),
                                                            getFontData(),
    ...
    public void readResources()
        ...
        LOGGER.debugStarinetEvent(LOADER_PROPERTIES.isStarinetDebug(),
                                  "StarinetPythonLogger [ResourceKey=" + getResourceKey() + "]");
