...
/***************************************************************************************************
 * ByVacDemonstratorRxStream.
 */

public final class ByVacDemonstratorRxStream extends AbstractRxStream
    ...
    /***********************************************************************************************
     * Construct a ByVacDemonstratorRxStream.
     *
     * @param resourcekey
     */

    public ByVacDemonstratorRxStream(final String resourcekey)
        {
        super(resourcekey);
    ...
    public boolean open() throws IOException
        ...
        LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                               "ByVacDemonstratorRxStream.open()");

        readResources();

        // We rely on the ByVacDemonstratorTxStream to set things up...
    ...
    public void close() throws IOException
        {
        LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                               "ByVacDemonstratorRxStream.close()");
    ...
    public void reset()
        {
        LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                               "ByVacDemonstratorRxStream.reset()");
        }
     ...
     * There are only three ByVacDemonstrator commands which produce a Response!
     *
    ...
    public ResponseMessageInterface read(final InstrumentsDocument instrumentsdoc) throws IOException
        ...
        if ((readBuffer != null)
            ...
            && (isReadyToRead()))
            {
            //LOGGER.debugProtocolEvent("ByVacDemonstratorRxStream.read() [bytes=" + Utilities.byteArrayToSpacedHex(readBuffer.toString().getBytes()) + "]");
            //LOGGER.debugProtocolEvent("ByVacDemonstratorRxStream.read() [bytes=" + Utilities.byteArrayToExpandedAscii(readBuffer.toString().getBytes()) + "]");
            ...
            response = ByVacDemonstratorResponseMessage.parseBytes(getCommandContext(),
                                                                   getHostPort().getHostDAOs(),
                                                                   readBuffer.toString().getBytes());
//            if (response != null)
//                {
//                LOGGER.debugProtocolEvent("ByVacDemonstratorRxStream.read() Message parsed, waiting for PortController to read");
//                }
//
//            if (response == null)
//                {
//                // TODO Review sending non-null response to avoid pseudo-timeout status
//                LOGGER.debugProtocolEvent("ByVacDemonstratorRxStream.read() Message parsing failed, pseudo-TIMEOUT behaviour");
//                }
...
//                {
//                LOGGER.debugProtocolEvent("ByVacDemonstratorRxStream.read() [ResponseValue=" + response.getCommandType().getResponse().getValue() + "]");
//                }
//            else if (response.getCommandType().getAck() != null)
//                {
//                LOGGER.debugProtocolEvent("ByVacDemonstratorRxStream.read() [Ack]");
//                }
//            }
    ...
    private void setReadyToRead(final boolean ready)
        {
        //LOGGER.debugTimedEvent("ByVacDemonstratorRxStream.setReadyToRead() [ready=" + ready + "]");
    ...
    public void readResources()
        {
        LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                               "ByVacDemonstratorRxStream.readResources() [ResourceKey=" + getResourceKey() + "]");
        }
    ...
    public final void serialEvent(final SerialPortEvent event)
        ...
        switch(event.getEventType())
            ...
            case SerialPortEvent.DATA_AVAILABLE:
                {
                //LOGGER.debugProtocolEvent("ByVacDemonstratorRxStream.serialEvent() SerialPortEvent.DATA_AVAILABLE");
                ...
                if (!isReadyToRead())
                    ...
                    try
                        ...
                        //LOGGER.debugTimedEvent("ByVacDemonstratorRxStream.serialEvent() ENTER SERIAL WAIT LOOP [length=" + readBuffer.length() + "]");

                        intRetries = RETRY_COUNT;
                        boolFoundEnough = false;

                        //LOGGER.debugTimedEvent("ByVacDemonstratorRxStream.serialEvent() [retries=" + intRetries + "]");
                        ...
                        while ((intRetries > 0)
                            ...
                            while ((getUnderlyingRxStream().available() > 0)
                                ...
                                // All ByVacDemonstrator Responses are 4 characters in length plus <cr>
                                boolFoundEnough = (readBuffer.length() == ByVacDemonstratorResponseMessage.LENGTH_VALID_RESPONSE);
                        ...
                        //LOGGER.debugTimedEvent("ByVacDemonstratorRxStream.serialEvent() LEAVE SERIAL WAIT LOOP [length=" + readBuffer.length() + "]");
//                        if (boolFoundEnough)
//                            {
//                            LOGGER.debugProtocolEvent("ByVacDemonstratorRxStream.serialEvent() Data assembled, ready to be read");
//                            }
                        }
                        ...
                        LOGGER.error("ByVacDemonstratorRxStream.serialEvent() ERROR IOException reading data from input stream");
                        }
                    }
                else
                    {
                    // This should never happen...
                    //LOGGER.error("ByVacDemonstratorRxStream.serialEvent() ERROR Waiting for PortController");
            ...
            case SerialPortEvent.OUTPUT_BUFFER_EMPTY:
                {
                LOGGER.error("ByVacDemonstratorRxStream.serialEvent() ERROR Serial Event type [eventtype=" + event.getEventType() + "]");
                break;
                }
            ...
            default:
                ...
                LOGGER.error("ByVacDemonstratorRxStream.serialEvent() ERROR Unknown Serial Event type [eventtype=" + event.getEventType() + "]");
                break;
                }
            }
        }
