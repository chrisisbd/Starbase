...
package org.lmn.fc.frameworks.starbase.plugins.observatory.ui.instruments.impl.toolkit.dao;
...
/***************************************************************************************************
 * ToolkitCommandMessage.
 */

public final class ToolkitCommandMessage extends AbstractCommandMessage
    {
    /***********************************************************************************************
     * Construct a ToolkitCommandMessage.
    ...
    public ToolkitCommandMessage(final ObservatoryInstrumentDAOInterface dao,
            ...
            if (command.getLegacyCode() != null)
                ...
                if (command.getParameterList().size() == 1)
                    ...
                    if ((parameter.getValue() != null)
                        ...
                        // Map the Parameter to a String appropriate to a ToolkitCommandMessage
                        ...
                        if (strParameter != null)
                            ...
                            LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                                                   "ToolkitCommandMessage.buildByteArray() [parameter="
                                                        + strParameter
                                                        + "] [datatype="
                            ...
                            LOGGER.error("ToolkitCommandMessage.buildByteArray() Invalid ParameterValue");
                            }
                        }
                    else
                        {
                        // Something is wrong with the data we have been given
                        LOGGER.error("ToolkitCommandMessage.buildByteArray() Invalid Parameter");
                        }
                    }
                else
                    {
                    LOGGER.error("ToolkitCommandMessage.buildByteArray() Command has an incorrect number of Parameters");
                    }
                }
            else
                {
                LOGGER.error("ToolkitCommandMessage.buildByteArray() Command does not have a LegacyCode");
                }
            }
        else
            {
