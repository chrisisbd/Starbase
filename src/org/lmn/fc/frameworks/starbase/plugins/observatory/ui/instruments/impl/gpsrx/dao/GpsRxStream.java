...
public final class GpsRxStream extends AbstractRxStream
                               implements PortRxStreamInterface
    {
    /***********************************************************************************************
     * Construct a GpsRxStream.
     *
     * @param resourcekey
     */

    public GpsRxStream(final String resourcekey)
        {
        super(resourcekey);
        }
    ...
    public void readResources()
        {
        LOGGER.debugGpsEvent(false,
                             "GpsRxStream.readResources() [ResourceKey=" + getResourceKey() + "]"
        );
        }
    }
