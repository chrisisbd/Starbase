...
/***********************************************************************************************
 * The AutoScaleChartUIComponent.
 */

public class AutoScaleChartUIComponent extends ChartUIComponent
        implements ChartUIComponentPlugin
    {
    /***********************************************************************************************
     * Construct a AutoScaleChartUIComponent.
     *
     * @param task
    ...
    public AutoScaleChartUIComponent(final TaskPlugin task,
    ...
    public JFreeChart createCustomisedChart(final DatasetType datasettype,
        ...
        // Ignore the Autorange switching, since it always autoranges
