...
/***************************************************************************************************
 * FunCubeDongleRxResponseMessage.
 */

public final class FunCubeDongleRxResponseMessage extends AbstractResponseMessage
    {
    /***********************************************************************************************
     * Construct a FunCubeDongleRxResponseMessage.
    ...
    public FunCubeDongleRxResponseMessage(final String portname,
...
//            && (XmlBeansUtilities.isValidXml(command))
    ...
    /***********************************************************************************************
     * Parse a byte array, attempting to find a MonitorResponseMessage
