...
/***************************************************************************************************
 * The GoesXrayClientControlPanel.
 */

public final class GoesXrayClientControlPanel extends InstrumentUIComponentDecorator
                                              implements ControlPanelInterface
    {
    // String Resources
    private static final String ICON_CONTROL = "goes-control.png";
    private static final String DEFAULT_FORMAT_0 = "10E-00Wm-2";
    private static final String DEFAULT_FORMAT_1 = "10E-00Wm-2";


    /***********************************************************************************************
     * Construct the GoesXrayClientControlPanel.
     *
     * @param instrument
     * @param instrumentxml
     * @param hostui
    ...
    public GoesXrayClientControlPanel(final ObservatoryInstrumentInterface instrument,
    ...
    public final void initialiseUI()
        ...
        getControlPanelIndicatorDefaultUnits().add(SchemaUnits.WM_2);
        getControlPanelIndicatorDefaultUnits().add(SchemaUnits.WM_2);
    ...
    public void instrumentChanged(final InstrumentStateChangedEvent event)
        {
        LOGGER.debugIndicators("GoesXrayClientControlPanel.instrumentChanged() --> update indicators");
