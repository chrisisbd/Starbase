...
public final class SpectraCyberStubRxStream extends AbstractRxStream
    ...
    /***********************************************************************************************
     * Construct a SpectraCyberStubRxStream.
     *
     * @param resourcekey
     */

    public SpectraCyberStubRxStream(final String resourcekey)
        {
        super(resourcekey);
    ...
    public void close() throws IOException
        {
        LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                               "SpectraCyberStubRxStream.close()");
    ...
    public void reset()
        {
        LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                               "SpectraCyberStubRxStream.reset()");
    ...
    public void readResources()
        {
        LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                               "SpectraCyberStubRxStream.readResources() [ResourceKey=" + getResourceKey() + "]");
        }
