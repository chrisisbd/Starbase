...
/***************************************************************************************************
 * The ObservatoryMonitorControlPanel.
 */

public final class ObservatoryMonitorControlPanel extends InstrumentUIComponentDecorator
                                                  implements ControlPanelInterface
    {
    // String Resources
    private static final String ICON_CONTROL = "monitor-control.png";


    /***********************************************************************************************
     * Construct the ObservatoryMonitorControlPanel.
     *
     * @param instrument
     * @param hostui
     * @param instrumentxml
    ...
    public ObservatoryMonitorControlPanel(final ObservatoryInstrumentInterface instrument,
    ...
    public void instrumentChanged(final InstrumentStateChangedEvent event)
        {
        LOGGER.debugIndicators("ObservatoryMonitorControlPanel.instrumentChanged() --> update indicators");
