...
/***************************************************************************************************
 * The GenericInstrumentControlPanel.
 */

public final class GenericInstrumentControlPanel extends InstrumentUIComponentDecorator
                                                 implements ControlPanelInterface
    {
    // String Resources
    private static final String ICON_CONTROL = "generic-rx-control.png";
    private static final String DEFAULT_FORMAT_0 = "99.99";
    private static final String DEFAULT_FORMAT_1 = "99.99";


    /***********************************************************************************************
     * Construct the GenericInstrumentControlPanel.
     *
     * @param instrument
     * @param instrumentxml
     * @param hostui
    ...
    public GenericInstrumentControlPanel(final ObservatoryInstrumentInterface instrument,
    ...
    public void instrumentChanged(final InstrumentStateChangedEvent event)
        {
        LOGGER.debugIndicators("GenericInstrumentControlPanel.instrumentChanged() --> update indicators");
