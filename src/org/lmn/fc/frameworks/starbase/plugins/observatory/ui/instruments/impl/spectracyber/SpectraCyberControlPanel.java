...
/***************************************************************************************************
 * The SpectraCyberControlPanel.
 */

public final class SpectraCyberControlPanel extends InstrumentUIComponentDecorator
    ...
    /***********************************************************************************************
     * Construct the SpectraCyberControlPanel.
     *
     * @param instrument
     * @param obsui
     * @param instrumentxml
    ...
    public SpectraCyberControlPanel(final ObservatoryInstrumentInterface instrument,
    ...
    public void instrumentChanged(final InstrumentStateChangedEvent event)
        {
        LOGGER.debugIndicators("SpectraCyberControlPanel.instrumentChanged() --> update indicators");
