...
public final class Starcam extends AbstractObservatoryInstrument
    ...
    public Starcam(final Instrument instrument,
    ...
    public final void initialise()
        ...
        // Read the Resources for the Starcam
        readResources();

        // Set up the Instrument
        super.initialise();

        // Create and initialise the Starcam ControlPanel
        controlPanel = new StarcamControlPanel(this,
                                               getInstrument(),
                                               getHostUI(),
        ...
        // Create an Starcam InstrumentPanel and initialise it
        instrumentPanel = new StarcamInstrumentPanel(this,
                                                     getInstrument(),
                                                     getHostUI(),
                                                     (TaskPlugin)getHostAtom().getRootTask(),
                                                     getFontData(),
    ...
    /* Utilities                                                                                  */
    /***********************************************************************************************
     * Read all the Resources required by the Starcam.
     */

    public void readResources()
        {
        LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                               "Starcam [ResourceKey=" + getResourceKey() + "]");
