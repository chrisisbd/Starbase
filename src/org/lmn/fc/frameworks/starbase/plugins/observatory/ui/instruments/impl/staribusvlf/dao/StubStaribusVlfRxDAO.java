...
/***************************************************************************************************
 * StubStaribusVlfRxDAO.
 */

public final class StubStaribusVlfRxDAO extends AbstractObservatoryInstrumentDAO
    ...
    /***********************************************************************************************
     * Construct a StubStaribusVlfRxDAO.
     *
     * @param hostinstrument
     */

    public StubStaribusVlfRxDAO(final ObservatoryInstrumentInterface hostinstrument)
        {
    ...
    public boolean initialiseDAO(final String resourcekey)
        ...
        LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                               "StubStaribusVlfRxDAO.initialiseDAO() [resourcekey=" + resourcekey + "]");
    ...
    public void disposeDAO()
        {
        LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                               "StubStaribusVlfRxDAO.disposeDAO()");
    ...
    public void readResources()
        {
        LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                               "StubStaribusVlfRxDAO.readResources() [ResourceKey=" + getResourceKey() + "]");
