...
public final class UnsubscribeFromRSS implements FrameworkConstants,
                                                 FrameworkStrings,
                                                 FrameworkMetadata,
                                                 FrameworkSingletons,
    ...
    public static ResponseMessageInterface doUnsubscribeFromRSS(final CommunicatorDAOInterface dao,
                                                                final CommandMessageInterface commandmessage)
        {
        final String SOURCE = "UnsubscribeFromRSS.doUnsubscribeFromRSS() ";
        ...
        if ((listParameters != null)
            ...
            if ((strName != null)
                ...
                {
                for (int i = 0;
                     (!boolFoundIt) && (i < listRssSubscription.size());
                     i++)
                    {
                    ...
                    if (boolFoundIt)
                        {
                        docSubscriptions.getSubscriptions().removeRSS(i);
                        }
                    }
                }
