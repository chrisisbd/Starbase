...
public class HydrogenRxDAO extends AbstractObservatoryInstrumentDAO
    ...
    /***********************************************************************************************
     * Construct a HydrogenRxDAO.
     *
     * @param hostinstrument
     */

    public HydrogenRxDAO(final ObservatoryInstrumentInterface hostinstrument)
        {
    ...
    public boolean initialiseDAO(final String resourcekey)
        ...
        LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                               "HydrogenRxDAO.initialiseDAO() [resourcekey=" + resourcekey + "]");
    ...
    public void readResources()
        {
        LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                               "HydrogenRxDAO.readResources() [ResourceKey=" + getResourceKey() + "]");
