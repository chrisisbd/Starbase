...
//------------------------------------------------------------------------------
// HorizonCapture StarMapPlugin
//------------------------------------------------------------------------------
// Revision History
//
//  10-10-02    LMN created file from original code in StarMap
//
//------------------------------------------------------------------------------
...
public final class HorizonCapture extends StarMapObject
    {

    public HorizonCapture(final ObservatoryUIInterface observatoryui,
    ...
    public final void drawObject(final Graphics graphics,
        ...
        {
        //LOGGER.debugTimedEvent("Drawing Pulsars at (" + starmapPoint.getPixelsXY().x + ", " + starmapPoint.getPixelsXY().y + ")");
