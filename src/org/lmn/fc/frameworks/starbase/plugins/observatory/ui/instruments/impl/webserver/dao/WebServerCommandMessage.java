...
/***************************************************************************************************
 * WebServerCommandMessage.
 */

public final class WebServerCommandMessage extends AbstractCommandMessage
    {
    /***********************************************************************************************
     * Construct a WebServerCommandMessage.
    ...
    public WebServerCommandMessage(final ObservatoryInstrumentDAOInterface dao,
            ...
            if (command.getLegacyCode() != null)
                ...
                if (command.getParameterList().size() == 1)
                    ...
                    if ((parameter.getValue() != null)
                        ...
                        // Map the Parameter to a String appropriate to a WebServerCommandMessage
                        ...
                        if (strParameter != null)
                            ...
                            LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                                                   "WebServerCommandMessage.buildByteArray() [parameter="
                                            + strParameter
                                            + "] [datatype="
                            ...
                            LOGGER.error("WebServerCommandMessage.buildByteArray() Invalid ParameterValue");
                            }
                        }
                    else
                        {
                        // Something is wrong with the data we have been given
                        LOGGER.error("WebServerCommandMessage.buildByteArray() Invalid Parameter");
                        }
                    }
                else
                    {
                    LOGGER.error("WebServerCommandMessage.buildByteArray() Command has an incorrect number of Parameters");
                    }
                }
            else
                {
                LOGGER.error("WebServerCommandMessage.buildByteArray() Command does not have a LegacyCode");
                }
            }
        else
            {
