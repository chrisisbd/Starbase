...
public final class ImportRawDataRemote implements FrameworkConstants,
                                                  FrameworkStrings,
                                                  FrameworkMetadata,
                                                  FrameworkSingletons,
                                                  FrameworkRegex,
    ...
    public static ResponseMessageInterface doImportRawDataRemote(final ObservatoryInstrumentDAOInterface dao,
                                                                 final CommandMessageInterface commandmessage)
        {
        final String SOURCE = "ImportRawDataRemote.doImportRawDataRemote()";
                    ...
                    if ((translator != null)
                        ...
                        if (boolInitialised)
                            ...
                            if (boolLoggedIn)
                                ...
                                dao.getRemoteDataConnection().setRemoteFilename(strRemoteFilename);
                                dao.getRemoteDataConnection().setLocalFilename(strRemoteFilename);
