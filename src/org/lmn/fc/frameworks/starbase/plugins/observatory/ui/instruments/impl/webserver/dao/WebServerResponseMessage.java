...
/***********************************************************************************************
 * WebServerResponseMessage.
 */

public final class WebServerResponseMessage
        extends AbstractResponseMessage
    {
    /***********************************************************************************************
     * Construct a WebServerResponseMessage.
    ...
    public WebServerResponseMessage(final String portname,
...
//            && (XmlBeansUtilities.isValidXml(command))
    ...
    /***********************************************************************************************
     * Parse a byte array, attempting to find a WebServerResponseMessage
