...
package org.lmn.fc.frameworks.starbase.plugins.observatory.ui.tabs.toolkit.smithchart;
...
public final class SmithChartUIComponent extends UIComponent
    ...
    public void paintComponent(final Graphics graphics)
        ...
        graphics.drawLine(Ptx - 5,
                          Pty, Ptx + 5,
                          Pty);//horizontal crossline for text input
        graphics.drawLine(Ptx, Pty - 5,
                          Ptx, Pty + 5);//vertical crossline for text input
        graphics.drawString("Z(Y)", Ptx + 8,
                            Pty);
...
//provides the value of the distance in wavelengths on the outer boundary
            graphics.drawString("\u03BB" + " = " + NumberFormat.getNumberInstance().format(0.25 - 0.25 * Math.atan2(Ys,
                                                                                                                    Xs) / Math.PI), (int) (185 + 170 * Math.cos(Math.atan2(Ys,
                                                                                                                                                                           Xs))), (int) (245 - 170 * Math.sin(Math.atan2(Ys,
                                                                                                                                                                                                                         Xs))));//radial
...
//for two positions and then calculates the length of a s/c stub
            ...
            graphics.setColor(color0);//VSWR circle and text
            graphics.drawString("\u03C1", mouseX + 5,
                                mouseY);
            graphics.drawLine(mouseX - 3,
                              mouseY, mouseX + 3,
                              mouseY);//horizontal crossline
            graphics.drawLine(mouseX, mouseY - 3,
                              mouseX, mouseY + 3);//vertical crossline
...
//graphics.drawLine(185,245,(int)(185+165*Math.cos(Math.atan2(Ys,Xs))),(int)(245-165*Math.sin(Math.atan2(Ys,Xs))));//radial
            graphics.drawLine((int) (185 - 165 * Math.cos(Math.atan2(Ys,
                                                                     Xs))), (int) (245 + 165 * Math.sin(Math.atan2(Ys,
                                                                                                                   Xs))), (int) (185 + 165 * Math.cos(Math.atan2(Ys,
                                                                                                                                                                 Xs))), (int) (245 - 165 * Math.sin(Math.atan2(Ys,
                                                                                                                                                                                                               Xs))));//radial

            final Point Pt = new Point((int) Math.sqrt(Xs * Xs + Ys * Ys), (int) Math.atan2(Ys,
                                                                                            Xs));
...
///////rho values
    ...
    private void lock1(final Graphics graphics)
        ...
        graphics.drawLine(185, 245, (int) (185 + 165 * Math.cos(Math.atan2(Yb,
                                                                           Xb))), (int) (245 - 165 * Math.sin(Math.atan2(Yb,
                                                                                                                         Xb))));//radial
        //provides the value of the distance in wavelengths on the outer boundary
        graphics.drawString("\u03BB" + "1" + " = " + NumberFormat.getNumberInstance().format(0.25 - 0.25 * Math.atan2(Yb,
                                                                                                                      Xb) / Math.PI), (int) (185 + 170 * Math.cos(Math.atan2(Yb,
                                                                                                                                                                             Xb))), (int) (245 - 170 * Math.sin(Math.atan2(Yb,
                                                                                                                                                                                                                           Xb))));//radial
        graphics.drawOval((int) (185 - radb), (int) (245 - radb), (int) (2 * radb), (int) (2 * radb));//VSWR circle
        if (Math.atan2(Yb,
                       Xb) - Math.atan2(Ys,
                                        Xs) >= 0)
            graphics.drawString("Difference in angles (" + "\u03BB" + " - " + "\u03BB" + "1) = " + NumberFormat.getNumberInstance().format(0.25 * (Math.atan2(Yb,
                                                                                                                                                              Xb) - Math.atan2(Ys,
                                                                                                                                                                               Xs)) / Math.PI) + " " + "\u03BB", 480, 150);
        else
            graphics.drawString("Difference in angles (" + "\u03BB" + " - " + "\u03BB" + "1) = " + NumberFormat.getNumberInstance().format(0.50 + (0.25 * (Math.atan2(Yb,
                                                                                                                                                                      Xb) - Math.atan2(Ys,
                                                                                                                                                                                       Xs)) / Math.PI)) + " " + "\u03BB", 480, 150);
        radc = rad1;
        Xc = Xs;
    ...
    private void lock2(final Graphics graphics)
        ...
        graphics.drawString("\u03BB" + "1" + " = " + NumberFormat.getNumberInstance().format(0.25 - 0.25 * Math.atan2(Yb,
                                                                                                                      Xb) / Math.PI), (int) (185 + 170 * Math.cos(Math.atan2(Yb,
                                                                                                                                                                             Xb))), (int) (245 - 170 * Math.sin(Math.atan2(Yb,
                                                                                                                                                                                                                           Xb))));//radial
        //graphics.drawOval((int)(185-radb),(int)(245-radb),(int)(2*radb),(int)(2*radb));//VSWR circle
        graphics.drawString("Difference in angles (" + "\u03BB" + "2" + " - " + "\u03BB" + "1) = " + NumberFormat.getNumberInstance().format(0.25 * (Math.atan2(Yb,
                                                                                                                                                                Xb) - Math.atan2(Yc,
                                                                                                                                                                                 Xc)) / Math.PI) + " " + "\u03BB", 480, 150);
        graphics.setColor(Color.green);//locked VSWR circle and angle
        graphics.drawLine(185, 245, (int) (185 + 165 * Math.cos(Math.atan2(Yc,
                                                                           Xc))), (int) (245 - 165 * Math.sin(Math.atan2(Yc,
                                                                                                                         Xc))));//radial
        //provides the value of the distance in wavelengths on the outer boundary
        graphics.drawString("\u03BB" + "2" + " = " + NumberFormat.getNumberInstance().format(0.25 - 0.25 * Math.atan2(Yc,
                                                                                                                      Xc) / Math.PI), (int) (185 + 170 * Math.cos(Math.atan2(Yc,
                                                                                                                                                                             Xc))), (int) (245 - 170 * Math.sin(Math.atan2(Yc,
                                                                                                                                                                                                                           Xc))));//radial
        ...
        if (0.25 * Math.atan2(Ys,
                              Xs) / Math.PI <= 0)
            graphics.drawString("Difference in angles (" + "\u03BB" + " - " + 0.25 + "\u03BB" + ") = " + NumberFormat.getNumberInstance().format(-0.25 * Math.atan2(Ys,
                                                                                                                                                                    Xs) / Math.PI) + " " + "\u03BB", 480, 190);
        else
            graphics.drawString("Difference in angles (" + "\u03BB" + " - " + 0.25 + "\u03BB" + ") = " + NumberFormat.getNumberInstance().format(0.50 - 0.25 * Math.atan2(Ys,
                                                                                                                                                                          Xs) / Math.PI) + " " + "\u03BB", 480, 190);
        }
    }
