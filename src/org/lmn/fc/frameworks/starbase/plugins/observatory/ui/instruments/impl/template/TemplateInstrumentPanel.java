...
/***************************************************************************************************
 * The TemplateInstrumentPanel.
 */

public final class TemplateInstrumentPanel extends InstrumentUIComponentDecorator
    {
    // String Resources
    private static final String ICON_HEADER_TEMPLATE = "template-header.png";

    private static final String INSTRUMENT_HELP = "TemplateHelp.html";
    ...
    /***********************************************************************************************
     * Construct a TemplateInstrumentPanel.
     *
     * @param instrument
     * @param instrumentxml
     * @param hostui
    ...
    public TemplateInstrumentPanel(final ObservatoryInstrumentInterface instrument,
    ...
    /***********************************************************************************************
     * Initialise the TemplateInstrumentPanel.
     */
    ...
    public final void initialiseUI()
        ...
        InstrumentUIHelper.configureInstrumentPanelHeader(getHeaderUIComponent(),
                                                          ...
                                                          getInstrument(),
                                                          ICON_HEADER_TEMPLATE,
                                                          getFontData(),
                                                          getColourData());

        // Create the TemplateInstrumentPanel and add it to the host UIComponent
    ...
    /* Utilities                                                                                  */
    /***********************************************************************************************
     * Create and initialise the JTabbedPane for the TemplateInstrumentPanel.
     */
