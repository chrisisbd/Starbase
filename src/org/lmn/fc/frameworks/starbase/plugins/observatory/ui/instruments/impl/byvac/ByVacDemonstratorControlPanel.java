...
/***************************************************************************************************
 * The ByVacDemonstratorControlPanel.
 */

public final class ByVacDemonstratorControlPanel extends InstrumentUIComponentDecorator
                                                 implements ControlPanelInterface
    {
    // String Resources
    private static final String ICON_CONTROL = "byvacdemo-control.png";


    /***********************************************************************************************
     * Construct the ByVacDemonstratorControlPanel.
     *
     * @param instrument
     * @param oui
     * @param instrumentxml
    ...
    public ByVacDemonstratorControlPanel(final ObservatoryInstrumentInterface instrument,
    ...
    public void instrumentChanged(final InstrumentStateChangedEvent event)
        {
        LOGGER.debugIndicators("ByVacDemonstratorControlPanel.instrumentChanged() --> update indicators");
