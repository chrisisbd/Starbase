...
/***************************************************************************************************
 * A SpectraCyberClient.
 */

public final class SpectraCyberClient extends AbstractObservatoryInstrument
                                      implements ObservatoryInstrumentInterface
    {
    /***********************************************************************************************
     * Construct a SpectraCyberClient.
     *
     * @param instrument
     * @param plugin
     * @param hostui
    ...
    public SpectraCyberClient(final Instrument instrument,
    ...
    /***********************************************************************************************
     * Initialise the SpectraCyberClient.
     */
    ...
    public void initialise()
        ...
        // Read the Resources for the SpectraCyberClient
        readResources();

        super.initialise();

        // Create and initialise the ControlPanel
        controlPanel = new SpectraCyberClientControlPanel(this,
                                                          getInstrument(),
                                                          getHostUI(),
        ...
        instrumentPanel = new SpectraCyberClientInstrumentPanel(this,
                                                                getInstrument(),
                                                                getHostUI(),
                                                                (TaskPlugin)getHostAtom().getRootTask(),
                                                                getFontData(),
    ...
    /* Utilities                                                                                  */
    /***********************************************************************************************
     *  Read all the Resources required by the SpectraCyberClient.
     */

    public void readResources()
        {
        LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                               "SpectraCyberClient [ResourceKey=" + getResourceKey() + "]");
