...
public final class ExportInstrumentLog implements FrameworkConstants,
                                                  FrameworkStrings,
                                                  FrameworkMetadata,
                                                  FrameworkSingletons,
    ...
    public static ResponseMessageInterface doExportInstrumentLog(final ObservatoryInstrumentDAOInterface dao,
                                                                 final CommandMessageInterface commandmessage)
        {
        final String SOURCE = "ExportInstrumentLog.exportInstrumentLog()";
        ...
        if ((dao.getWrappedData() != null)
            ...
            try
                ...
                if (translator != null)
                    ...
                    // The InstrumentLog comes directly from the host Instrument
                    ...
                    boolSuccess = dao.getTranslator().exportLog(dao.getHostInstrument().getInstrumentLogMetadata(),
                                                                dao.getHostInstrument().getInstrumentLog(),
                                                                dao.getHostInstrument().getInstrumentLogWidth(),
                                                                strFilename,
                                                                boolTimestamp,
