...
public final class ExportConfiguration implements FrameworkConstants,
                                                  FrameworkStrings,
                                                  FrameworkMetadata,
                                                  FrameworkSingletons,
    ...
    public static ResponseMessageInterface doExportConfiguration(final ObservatoryInstrumentDAOInterface dao,
                                                                 final CommandMessageInterface commandmessage)
        {
        final String SOURCE = "ExportConfiguration.exportConfiguration()";
        ...
        if ((dao.getHostInstrument() != null)
            ...
            try
                ...
                if (translator != null)
                    ...
                    // Use the Observatory Atom ResourceKey to correctly identify the Configuration items
                    boolSuccess = dao.getTranslator().exportConfiguration(null,
                                                                          dao.getHostInstrument().getInstrument(),
                                                                          dao.getHostInstrument().getInstrumentConfiguration(),
                                                                          dao.getHostInstrument().getHostAtom().getResourceKey(),
                                                                          dao.getHostInstrument().getResourceKey(),
                                                                          strFilename,
                                                                          boolTimestamp,
