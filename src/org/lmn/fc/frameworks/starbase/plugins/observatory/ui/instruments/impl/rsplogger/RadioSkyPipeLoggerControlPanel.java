...
/***************************************************************************************************
 * The RadioSkyPipeLoggerControlPanel.
 */

public final class RadioSkyPipeLoggerControlPanel extends InstrumentUIComponentDecorator
                                                  implements ControlPanelInterface
    {
    // String Resources
    private static final String ICON_CONTROL = "rsp-logger-control.png";


    /***********************************************************************************************
     * Construct the RadioSkyPipeLoggerControlPanel.
     *
     * @param instrument
     * @param instrumentxml
     * @param hostui
    ...
    public RadioSkyPipeLoggerControlPanel(final ObservatoryInstrumentInterface instrument,
    ...
    public void instrumentChanged(final InstrumentStateChangedEvent event)
        {
        LOGGER.debugIndicators("RadioSkyPipeLoggerControlPanel.instrumentChanged() --> update indicators");
