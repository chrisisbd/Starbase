...
/***********************************************************************************************
 * BasicInstrumentResponseMessage.
 */

public final class BasicInstrumentResponseMessage extends AbstractResponseMessage
    {
    /***********************************************************************************************
     * Construct a BasicInstrumentResponseMessage.
    ...
    public BasicInstrumentResponseMessage(final String portname,
        ...
        if ((portname != null)
            ...
            // Why would this have to be Virtual
//            && (ObservatoryInstrumentHelper.isVirtualController(instrumentxml))
    ...
    /***********************************************************************************************
     * Parse a byte array, attempting to find a BasicInstrumentResponseMessage
