...
/***************************************************************************************************
 * The GenericInstrumentInstrumentPanel.
 */

public final class GenericInstrumentInstrumentPanel extends InstrumentUIComponentDecorator
    {
    // String Resources
    private static final String ICON_HEADER = "generic-rx-header.png";

    private static final String INSTRUMENT_HELP = "GenericRxHelp.html";


    /***********************************************************************************************
     * Construct a GenericInstrumentInstrumentPanel.
     *
     * @param instrument
     * @param instrumentxml
     * @param hostui
    ...
    public GenericInstrumentInstrumentPanel(final ObservatoryInstrumentInterface instrument,
    ...
    /***********************************************************************************************
     * Initialise the GenericInstrumentInstrumentPanel.
     */
    ...
    public final void initialiseUI()
        ...
        // Create the GenericInstrumentInstrumentPanel and add it to the host UIComponent
    ...
    public void instrumentChanged(final InstrumentStateChangedEvent event)
        {
        final String SOURCE = "GenericInstrumentInstrumentPanel.instrumentChanged() ";
    ...
    /* Utilities                                                                                  */
    /***********************************************************************************************
     * Create and initialise the JTabbedPane for the GenericInstrumentInstrumentPanel.
     */
