...
/***************************************************************************************************
 * MetadataNVPViewerUIComponent.
 */

public final class MetadataNVPViewerUIComponent extends ReportTable
                                                implements MetadataNVPViewerUIComponentInterface
    {
    private static final long serialVersionUID = 1199881042074675284L;
    ...
    /***********************************************************************************************
     * Construct an MetadataNVPViewerUIComponent.
    ...
    public MetadataNVPViewerUIComponent(final TaskPlugin task,
    ...
    public final Vector<String> generateHeader()
        ...
        vecHeader.add("This report shows all loaded Metadata, ordered by Name");
    ...
    public final Vector<Vector> generateReport()
        {
        final String SOURCE = "MetadataNVPViewerUIComponent.generateReport() ";
