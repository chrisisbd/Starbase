...
package org.lmn.fc.frameworks.starbase.plugins.observatory.ui.instruments.impl.rsplogger;
...
/***************************************************************************************************
 * The RadioSkyPipeLoggerInstrumentPanel.
 */

public final class RadioSkyPipeLoggerInstrumentPanel extends InstrumentUIComponentDecorator
    {
    // String Resources
    private static final String ICON_HEADER_RSP_LOGGER = "rsp-logger-header.png";

    private static final String INSTRUMENT_HELP = "RadioSkyPipeLoggerHelp.html";
    ...
    /***********************************************************************************************
     * Construct a RadioSkyPipeLoggerInstrumentPanel.
     *
     * @param instrument
     * @param instrumentxml
     * @param hostui
    ...
    public RadioSkyPipeLoggerInstrumentPanel(final ObservatoryInstrumentInterface instrument,
    ...
    /***********************************************************************************************
     * Initialise the RadioSkyPipeLoggerInstrumentPanel.
     */
    ...
    public final void initialiseUI()
        ...
        InstrumentUIHelper.configureInstrumentPanelHeader(getHeaderUIComponent(),
                                                          ...
                                                          getInstrument(),
                                                          ICON_HEADER_RSP_LOGGER,
                                                          getFontData(),
                                                          getColourData());

        // Create the RadioSkyPipeLoggerInstrumentPanel and add it to the host UIComponent
    ...
    /* Utilities                                                                                  */
    /***********************************************************************************************
     * Create and initialise the JTabbedPane for the RadioSkyPipeLoggerInstrumentPanel.
     */
