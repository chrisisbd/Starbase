...
public final class ExportProcessedData implements FrameworkConstants,
                                                  FrameworkStrings,
                                                  FrameworkMetadata,
                                                  FrameworkSingletons,
    ...
    public static ResponseMessageInterface doExportProcessedData(final ObservatoryInstrumentDAOInterface dao,
                                                                 final CommandMessageInterface commandmessage)
        {
        final String SOURCE = "ExportProcessedData.exportProcessedData()";
        ...
        if ((dao.getWrappedData() != null)
            ...
            try
                ...
                if (translator != null)
                    ...
                    boolSuccess = dao.getTranslator().exportXYDataset(dao.getWrappedData(),
                                                                      strFilename,
                                                                      boolTimestamp,
