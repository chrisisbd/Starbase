...
public final class ExportSubversionLog implements FrameworkConstants,
                                                 FrameworkStrings,
                                                 FrameworkMetadata,
                                                 FrameworkSingletons,
    ...
    public static ResponseMessageInterface doExportSubversionLog(final ObservatoryInstrumentDAOInterface dao,
                                                                final CommandMessageInterface commandmessage)
        {
        final String SOURCE = "ExportSubversionLog.doExportSubversionLog()";
        ...
        if ((dao.getHostInstrument() != null)
            ...
            // assuming that the Subversion RSS reader has been running???
            ...
            if (((dao.getHostInstrument() != null))
                ...
                {
                final UIComponentPlugin uiSVN;
                final StringBuffer buffer;

                uiSVN = ((CommunicatorInstrumentPanel)dao.getHostInstrument().getInstrumentPanel()).getSubversionTab();

                if ((uiSVN != null)
                    && (uiSVN instanceof SimpleNewsreaderPanel))
                    {
                    buffer = new StringBuffer(((SimpleNewsreaderPanel)uiSVN).getNewsText());
