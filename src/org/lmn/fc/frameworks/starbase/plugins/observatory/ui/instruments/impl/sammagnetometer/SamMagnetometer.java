...
public final class SamMagnetometer extends AbstractObservatoryInstrument
                                   implements ObservatoryInstrumentInterface
    {
    /***********************************************************************************************
     * Construct a SamMagnetometer.
     *
     * @param instrument
     * @param plugin
     * @param hostui
    ...
    public SamMagnetometer(final Instrument instrument,
    ...
    /***********************************************************************************************
     * Initialise the SamMagnetometer.
     */
    ...
    public void initialise()
        ...
        // Read the Resources for the SamMagnetometer
        readResources();

        super.initialise();

        // Create and initialise the SamMagnetometerControlPanel
        controlPanel = new SamMagnetometerControlPanel(this,
                                                       getInstrument(),
                                                       getHostUI(),
        ...
        // Create a SamMagnetometerInstrumentPanel and initialise it
        instrumentPanel = new SamMagnetometerInstrumentPanel(this,
                                                             getInstrument(),
                                                             getHostUI(),
                                                             (TaskPlugin)getHostAtom().getRootTask(),
                                                             getFontData(),
    ...
    /* Utilities                                                                                  */
    /***********************************************************************************************
     *  Read all the Resources required by the SamMagnetometer.
     */

    public void readResources()
        {
        LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                               "SamMagnetometer [ResourceKey=" + getResourceKey() + "]");
