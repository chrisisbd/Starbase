...
import org.lmn.fc.frameworks.starbase.plugins.observatory.ui.instruments.common.dao.StaribusCommandMessage;
import org.lmn.fc.frameworks.starbase.plugins.observatory.ui.instruments.common.dao.StaribusResponseMessage;
...
//
// See e.g. http://www.nsftools.com/tips/RawFTP.htm
//
/***************************************************************************************************
 * CombinedVlfRxDAO.
...
public final class CombinedVlfRxDAO extends AbstractObservatoryInstrumentDAO
    ...
    /***********************************************************************************************
     * Construct a CombinedVlfRxDAO.
     *
     * @param hostinstrument
     */

    public CombinedVlfRxDAO(final ObservatoryInstrumentInterface hostinstrument)
        {
    ...
    public boolean initialiseDAO(final String resourcekey)
        {
        final String SOURCE = "CombinedVlfRxDAO.initialiseDAO() ";
    ...
    /***********************************************************************************************
     * Read all the Resources required by the CombinedVlfRxDAO.
     *
    ...
    public void readResources()
        {
        final String SOURCE = "CombinedVlfRxDAO.readResources() ";
        final boolean boolDebug;
