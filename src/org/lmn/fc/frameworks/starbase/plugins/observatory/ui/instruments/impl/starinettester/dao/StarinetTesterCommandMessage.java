...
/***************************************************************************************************
 * StarinetTesterCommandMessage.
 */

public final class StarinetTesterCommandMessage extends AbstractCommandMessage
    {
    /***********************************************************************************************
     * Construct a StarinetTesterCommandMessage.
    ...
    public StarinetTesterCommandMessage(final ObservatoryInstrumentDAOInterface dao,
        ...
        if ((dao != null)
            ...
            this.streamTarget = StreamType.STARINET;
