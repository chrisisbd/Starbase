...
/***************************************************************************************************
 * SpectraCyberServerTxStream.
 */

public final class SpectraCyberServerTxStream extends AbstractTxStream
    ...
    /***********************************************************************************************
     * Construct a SpectraCyberServerTxStream.
     *
     * @param resourcekey
     */

    public SpectraCyberServerTxStream(final String resourcekey)
        {
        super(resourcekey);
    ...
    public boolean open() throws IOException
        {
        final String SOURCE = "SpectraCyberServerTxStream.open()";
        ...
        try
            ...
            if (getSerialPort() != null)
                ...
                if (getLoopbackRxStream() instanceof SerialPortEventListener)
                    ...
                    {
                    LOGGER.error("SpectraCyberServerTxStream.open() LoopbackStream is not a SerialPortEventListener");
                    }
                }
            }
            ...
            {
            throw new IOException("SpectraCyberServerTxStream.open()", exception);
            }
    ...
    public void close() throws IOException
        {
        final String SOURCE = "SpectraCyberServerTxStream.close()";
    ...
    public void reset()
        {
        final String SOURCE = "SpectraCyberServerTxStream.reset()";
        }
    ...
    public final void write(final InstrumentsDocument instrumentsdoc,
        ...
        {
        final String SOURCE = "SpectraCyberServerTxStream.write()";
        ...
        if ((getSerialPort() != null)
            ...
            && (isStreamOpen()))
            {
            //System.out.println("SpectraCyberServerTxStream.write() sending bytes=[" + Utilities.byteArrayToSpacedHex(commandmessage.getByteArray()) +"]");
            //LOGGER.debugTimedEvent("SpectraCyberServerTxStream.write() sending bytes=[" + Utilities.byteArrayToExpandedAscii(commandmessage.getByteArray()) +"]");
            //LOGGER.debugProtocolEvent("SpectraCyberServerTxStream.write() sending String=[" + new String(commandmessage.getByteArray()) +"]");
            ...
            if ((getHostPort() != null)
                && (getHostPort().getRxStream() != null))
                {
                // This CommandContext *must* contain the Instrument, Module,Command
            ...
            LOGGER.debugCommandEvent(LOADER_PROPERTIES.isStaribusDebug(),
                                      "SpectraCyberServerTxStream.write() ERROR Unable to transmit");
            }
        }
    ...
    public final void readResources()
        {
        //System.out.println("SpectraCyberServerTxStream.readResources() [ResourceKey=" + getResourceKey() + "]");
