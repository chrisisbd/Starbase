...
package org.lmn.fc.frameworks.starbase.plugins.observatory.ui.instruments.impl.antennatester.dao;
...
public final class AntennaTesterDAO extends AbstractObservatoryInstrumentDAO
    ...
    /***********************************************************************************************
     * Construct a AntennaTesterDAO.
     *
     * @param hostinstrument
     */

    public AntennaTesterDAO(final ObservatoryInstrumentInterface hostinstrument)
        {
    ...
    public boolean initialiseDAO(final String resourcekey)
        ...
        LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                               "AntennaTesterDAO.initialiseDAO() [resourcekey=" + resourcekey + "]");
    ...
    public CommandMessageInterface constructCommandMessage(final ObservatoryInstrumentDAOInterface dao,
        ...
        {
        return (new AntennaTesterCommandMessage(dao,
                                                instrumentxml,
                                                module,
                                                command,
                                                starscript.trim()));
    ...
    public ResponseMessageInterface constructResponseMessage(final String portname,
        ...
        {
        return (new AntennaTesterResponseMessage(portname,
                                                 instrumentxml,
                                                 module,
                                                 command,
                                                 starscript.trim(),
    ...
    /***********************************************************************************************
     * Read all the Resources required by the AntennaTesterDAO.
     *
    ...
    public void readResources()
        {
        LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                               "AntennaTesterDAO.readResources() [ResourceKey=" + getResourceKey() + "]");
