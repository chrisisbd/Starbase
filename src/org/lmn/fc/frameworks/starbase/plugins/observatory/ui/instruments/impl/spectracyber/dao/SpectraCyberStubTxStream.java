...
/***************************************************************************************************
 * SpectraCyberStubTxStream.
 */

public final class SpectraCyberStubTxStream extends AbstractTxStream
    ...
    /***********************************************************************************************
     * Construct a SpectraCyberStubTxStream.
     *
     * @param resourcekey
     */

    public SpectraCyberStubTxStream(final String resourcekey)
        {
        super(resourcekey);
    ...
    public void close() throws IOException
        {
        LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                               "SpectraCyberStubTxStream.close()");
    ...
    public void reset()
        {
        LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                               "SpectraCyberStubTxStream.reset()");
    ...
    public void flush() throws IOException
        ...
        LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                               "SpectraCyberStubTxStream.flush()");
    ...
    public final void write(final InstrumentsDocument instrumentsdoc,
        ...
        LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                               "SpectraCyberStubTxStream sending bytes=[" + Utilities.byteArrayToExpandedAscii(command.getByteArray()) +"]");
...
//        ((StubStaribusRxStream)getLoopbackRxStream()).putResponseToStream(responseParsed);
    ...
    public final void readResources()
        {
        LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                               "SpectraCyberStubTxStream.readResources() [ResourceKey=" + getResourceKey() + "]");
