...
//
/***************************************************************************************************
 * StarinetCommandMessage.
 */

public final class StarinetCommandMessage extends AbstractCommandMessage
    {
    /***********************************************************************************************
    ...
    private synchronized static List<Byte> buildStarinetByteArray(final Instrument instrumentxml,
                                                                  ...
                                                                  final StreamType targetstream,
                                                                  final int targetaddress,
                                                                  final boolean debugmode)
        {
        final String SOURCE = "StarinetCommandMessage.buildStarinetByteArray() ";
        ...
        intChecksum = Utilities.addStringToMessage(message,
                                                   Utilities.intToTwoHexString(targetaddress),
                                                   intChecksum);
        // Add the CommandCode
        ...
        if ((command.getParameterList() != null)
            ...
            while (iterParameters.hasNext())
                ...
                if ((parameter.getValue() != null)
                    ...
                    strParameter = parameterValueToMessageString(parameter, targetstream);
    ...
    public synchronized static String parameterValueToMessageString(final ParameterType parameter,
                                                                    final StreamType targetstream)
        {
        final String SOURCE = "StarinetCommandMessage.parameterValueToMessageString() ";
        ...
        switch (dataType)
            ...
            case BOOLEAN:
                {
                // Sending Staribus over Starinet means we need to change the Boolean representation
                if (StreamType.STARIBUS.equals(targetstream))
                    {
            ...
            case NUMERIC_INDEXED_LIST:
                {
                LOGGER.debugStaribusEvent(LOADER_PROPERTIES.isStarinetDebug(),
    ...
    /***********************************************************************************************
     * Construct a StarinetCommandMessage.
    ...
    public StarinetCommandMessage(final ObservatoryInstrumentDAOInterface dao,
        ...
        {
        final String SOURCE = "StarinetCommandMessage ";
        ...
        if ((dao != null)
            ...
            this.streamTarget = targetstream;
