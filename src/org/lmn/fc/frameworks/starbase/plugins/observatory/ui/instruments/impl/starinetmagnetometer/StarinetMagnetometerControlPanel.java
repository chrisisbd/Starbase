...
/***************************************************************************************************
 * The MagnetometerControlPanel.
 */

public final class StarinetMagnetometerControlPanel extends InstrumentUIComponentDecorator
                                                    implements ControlPanelInterface
    {
    // String Resources
    private static final String ICON_CONTROL = "starinet-magnetometer-control.png";
    private static final String DEFAULT_DATA_FORMAT_0 = "+0000";
    private static final String DEFAULT_DATA_FORMAT_1 = "+0000";


    /***********************************************************************************************
     * Construct the MagnetometerControlPanel.
     *
     * @param instrument
     * @param instrumentxml
     * @param hostui
    ...
    public StarinetMagnetometerControlPanel(final ObservatoryInstrumentInterface instrument,
    ...
    public void instrumentChanged(final InstrumentStateChangedEvent event)
        {
        LOGGER.debugIndicators("StarinetMagnetometerControlPanel.instrumentChanged() --> update indicators");
