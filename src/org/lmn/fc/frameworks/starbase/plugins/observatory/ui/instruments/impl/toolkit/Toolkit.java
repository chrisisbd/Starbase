...
public final class Toolkit extends AbstractObservatoryInstrument
    ...
    public Toolkit(final Instrument instrument,
    ...
    public final void initialise()
        ...
        // Read the Resources for the Toolkit
        readResources();
        ...
        controlPanel = new ToolkitControlPanel(this,
                                               getInstrument(),
                                               getHostUI(),
        ...
        // Create an ToolkitInstrumentPanel and initialise it
        instrumentPanel = new ToolkitInstrumentPanel(this,
                                                     getInstrument(),
                                                     getHostUI(),
                                                     (TaskPlugin)getHostAtom().getRootTask(),
                                                     getFontData(),
    ...
    /* Utilities                                                                                  */
    /***********************************************************************************************
     * Read all the Resources required by the Toolkit.
     */

    public void readResources()
        {
        LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                               "Toolkit [ResourceKey=" + getResourceKey() + "]");
