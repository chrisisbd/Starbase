...
public final class Repository extends AbstractObservatoryInstrument
    ...
    public Repository(final Instrument instrument,
    ...
    public final void initialise()
        ...
        // Read the Resources for the Repository
        readResources();
        ...
        controlPanel = new RepositoryControlPanel(this,
                                                  getInstrument(),
                                                  getHostUI(),
        ...
        // Create an RepositoryInstrumentPanel and initialise it
        instrumentPanel = new RepositoryInstrumentPanel(this,
                                                        getInstrument(),
                                                        getHostUI(),
                                                        (TaskPlugin)getHostAtom().getRootTask(),
                                                        getFontData(),
    ...
    /* Utilities                                                                                  */
    /***********************************************************************************************
     * Read all the Resources required by the Repository.
     */

    public void readResources()
        {
        LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                               "Repository [ResourceKey=" + getResourceKey() + "]");
