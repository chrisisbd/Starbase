...
/***************************************************************************************************
 * The StaribusVlfReceiver.
 */

public final class StaribusVlfReceiver extends AbstractObservatoryInstrument
    ...
    /***********************************************************************************************
     * Construct a StaribusVlfReceiver.
     *
     * @param instrument
     * @param plugin
     * @param hostui
    ...
    public StaribusVlfReceiver(final Instrument instrument,
    ...
    /***********************************************************************************************
     * Initialise the StaribusVlfReceiver.
     */
    ...
    public final void initialise()
        ...
        // Read the Resources for the StaribusVlfReceiver
        readResources();
        ...
        controlPanel = new StaribusVlfReceiverControlPanel(this,
                                                           getInstrument(),
                                                           getHostUI(),
        ...
        instrumentPanel = new StaribusVlfReceiverInstrumentPanel(this,
                                                                 getInstrument(),
                                                                 getHostUI(),
                                                                 (TaskPlugin)getHostAtom().getRootTask(),
                                                                 getFontData(),
    ...
    /* Utilities                                                                                  */
    /***********************************************************************************************
     * Read all the Resources required by the StaribusVlfReceiver.
     */

    public void readResources()
        {
        LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                               "StaribusVlfReceiver [ResourceKey=" + getResourceKey() + "]");
