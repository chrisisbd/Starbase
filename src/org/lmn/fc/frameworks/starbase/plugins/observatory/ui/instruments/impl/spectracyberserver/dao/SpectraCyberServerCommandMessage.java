...
/***************************************************************************************************
 * SpectraCyberServerCommandMessage.
 */

public final class SpectraCyberServerCommandMessage extends AbstractCommandMessage
    {
    /***********************************************************************************************
     * Construct a SpectraCyberServerCommandMessage.
     * Save the original StarScript representation of this Command.
     * Supply the bytes to send to the Port.
     *
     * @param dao
     * @param instrumentxml
     * @param module
    ...
    public SpectraCyberServerCommandMessage(final ObservatoryInstrumentDAOInterface dao,
        ...
        if ((dao != null)
            ...
            this.listBytes = Utilities.byteArrayToList(bytes);
...
//            && (XmlBeansUtilities.isValidXml(command))
            ...
            this.selectedModule = module;
            this.selectedCommand = command;
            this.streamTarget = StreamType.ETHERNET;
            ...
            if (command.getLegacyCode() != null)
                ...
                if (command.getParameterList().size() == 1)
                    ...
                    if ((parameter.getValue() != null)
                        ...
                        // Map the Parameter to a String appropriate to a SpectraCyberServerCommandMessage
                        ...
                        if (strParameter != null)
                            ...
                            LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                                                   "SpectraCyberServerCommandMessage.buildByteArray() [parameter="
                                                    + strParameter
                                                    + "] [datatype="
                            ...
                            LOGGER.error("SpectraCyberServerCommandMessage.buildByteArray() Invalid ParameterValue");
                            }
                        }
                    else
                        {
                        // Something is wrong with the data we have been given
                        LOGGER.error("SpectraCyberServerCommandMessage.buildByteArray() Invalid Parameter");
                        }
                    }
                else
                    {
                    LOGGER.error("SpectraCyberServerCommandMessage.buildByteArray() Command has an incorrect number of Parameters");
                    }
                }
            else
                {
                LOGGER.error("SpectraCyberServerCommandMessage.buildByteArray() Command does not have a LegacyCode");
                }
            }
        else
            {
