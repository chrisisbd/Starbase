...
/***************************************************************************************************
 * SpectraCyberCommandMessage.
 */

public final class SpectraCyberCommandMessage extends AbstractCommandMessage
    {
    /***********************************************************************************************
    ...
    private synchronized static List<Byte> buildByteArray(final Instrument instrumentxml,
        ...
        //LOGGER.debugProtocolEvent("SpectraCyberCommandMessage.buildByteArray()");
        ...
        if ((command.getParameterList() != null)
            ...
            if (command.getLegacyCode() != null)
                ...
                //LOGGER.debugProtocolEvent("SpectraCyberCommandMessage.buildByteArray() [legacy_message=" + Utilities.byteListToString(message) + "]");
                ...
                if (command.getParameterList().size() == 1)
                    ...
                    if ((parameter.getValue() != null)
                        ...
                        // Map the Parameter to a String appropriate to a SpectraCyberCommandMessage
                        // Applies to:
                        //      setNoiseSource()
...
//                            LOGGER.debugProtocolEvent("SpectraCyberCommandMessage.buildByteArray() [parameter="
//                                                        + strParameter
//                                                        + "] [datatype="
...
//                                                        + "]");
                            ...
                            LOGGER.error("SpectraCyberCommandMessage.buildByteArray() Invalid ParameterValue");
                            }
                        }
                    else
                        {
                        // Something is wrong with the data we have been given
                        LOGGER.error("SpectraCyberCommandMessage.buildByteArray() Invalid Parameter");
                        }
                    }
                else
                    {
                    LOGGER.error("SpectraCyberCommandMessage.buildByteArray() Command has an incorrect number of Parameters");
                    }
                }
            else
                {
                LOGGER.error("SpectraCyberCommandMessage.buildByteArray() Command does not have a LegacyCode");
                }
            }
        else
            {
        ...
        //LOGGER.debugProtocolEvent("SpectraCyberCommandMessage.buildByteArray() [message=" + Utilities.byteListToString(message) + "]");
    ...
    private synchronized static String parameterValueToMessageString(final ParameterType parameter)
        ...
        //LOGGER.debugProtocolEvent("SpectraCyberCommandMessage.parameterValueToMessageString() [starscript=" + strStarScriptValue + "]");
...
//                        System.out.println("dblOutput=" + dblOutput);
            ...
            default:
                ...
                LOGGER.error("SpectraCyberCommandMessage.parameterValueToMessageString() Invalid TrafficDataType");
                }
            }

        //LOGGER.debugProtocolEvent("SpectraCyberCommandMessage.parameterValueToMessageString() [message_string=" + strMessageString + "]");
    ...
    /***********************************************************************************************
     * Construct a SpectraCyberCommandMessage.
    ...
    public SpectraCyberCommandMessage(final ObservatoryInstrumentDAOInterface dao,
