...
public final class RepositoryDAO extends AbstractObservatoryInstrumentDAO
    ...
    /***********************************************************************************************
     * Construct a RepositoryRxDAO.
     *
     * @param hostinstrument
     */

    public RepositoryDAO(final ObservatoryInstrumentInterface hostinstrument)
        {
    ...
    public boolean initialiseDAO(final String resourcekey)
        ...
        LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                               "RepositoryRxDAO.initialiseDAO() [resourcekey=" + resourcekey + "]");
    ...
    public CommandMessageInterface constructCommandMessage(final ObservatoryInstrumentDAOInterface dao,
        ...
        {
        return (new RepositoryCommandMessage(dao,
                                             instrumentxml,
                                             module,
                                             command,
                                             starscript.trim()));
    ...
    public ResponseMessageInterface constructResponseMessage(final String portname,
        ...
        {
        return (new RepositoryResponseMessage(portname,
                                              instrumentxml,
                                              module,
                                              command,
                                              starscript.trim(),
    ...
    /***********************************************************************************************
     * Read all the Resources required by the RepositoryRxDAO.
     *
    ...
    public void readResources()
        {
        LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                               "RepositoryRxDAO.readResources() [ResourceKey=" + getResourceKey() + "]");
