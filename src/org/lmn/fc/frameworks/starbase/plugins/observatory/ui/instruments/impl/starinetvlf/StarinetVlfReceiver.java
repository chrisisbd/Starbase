...
package org.lmn.fc.frameworks.starbase.plugins.observatory.ui.instruments.impl.starinetvlf;
...
/***************************************************************************************************
 * The StarinetVlfReceiver.
 */

public final class StarinetVlfReceiver extends AbstractObservatoryInstrument
                                       implements ObservatoryInstrumentInterface
    {
    // Max and min values, in milliVolts
    private static final double CHART_MIN_VALUE = 0.0;
    private static final double CHART_MAX_VALUE = 2500.0;


    /***********************************************************************************************
     * Construct a StarinetVlfReceiver.
     *
     * @param instrument
     * @param plugin
     * @param hostui
    ...
    public StarinetVlfReceiver(final Instrument instrument,
    ...
    /***********************************************************************************************
     * Initialise the StarinetVlfReceiver.
     */
    ...
    public final void initialise()
        ...
        // Read the Resources for the StarinetVlfReceiver
        readResources();

        // Set up the Instrument
        super.initialise();

        // Create and initialise the VLF ControlPanel
        controlPanel = new StarinetVlfReceiverControlPanel(this,
                                                           getInstrument(),
                                                           getHostUI(),
        ...
        // Create an StaribusVlfReceiverInstrumentPanel and initialise it
        instrumentPanel = new StarinetVlfReceiverInstrumentPanel(this,
                                                                 getInstrument(),
                                                                 getHostUI(),
                                                                 (TaskPlugin)getHostAtom().getRootTask(),
                                                                 getFontData(),
    ...
    /* Utilities                                                                                  */
    /***********************************************************************************************
     * Read all the Resources required by the StarinetVlfReceiver.
     */

    public void readResources()
        {
        LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                               "StarinetVlfReceiver [ResourceKey=" + getResourceKey() + "]");
