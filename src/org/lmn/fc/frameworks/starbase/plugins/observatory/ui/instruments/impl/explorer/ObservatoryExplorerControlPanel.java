...
/***************************************************************************************************
 * The ObservatoryExplorerControlPanel.
 */

public final class ObservatoryExplorerControlPanel extends InstrumentUIComponentDecorator
                                                   implements ControlPanelInterface
    {
    private static final String ICON_CONTROL = "observatory-explorer-control.png";


    /***********************************************************************************************
     * Construct the ObservatoryExplorerControlPanel.
     *
     * @param instrument
     * @param instrumentxml
     * @param hostui
    ...
    public ObservatoryExplorerControlPanel(final ObservatoryInstrumentInterface instrument,
    ...
    public void instrumentChanged(final InstrumentStateChangedEvent event)
        {
        LOGGER.debugIndicators("ObservatoryExplorerControlPanel.instrumentChanged() --> update indicators");
