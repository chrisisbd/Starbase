...
/***************************************************************************************************
 * AveragingFFTDAOInterface.
 */

public interface AveragingFFTDAOInterface extends ObservatoryInstrumentDAOInterface,
                                                  MetadataChangedListener
    {
    int DAO_CHANNEL_COUNT = 1;
    ...
    void processData(AveragingFFTFrameUIComponentInterface hostframeui,
                     JComponent monitor,
                     boolean run);
