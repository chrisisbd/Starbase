...
public final class ExportMantisIssues implements FrameworkConstants,
                                                 FrameworkStrings,
                                                 FrameworkMetadata,
                                                 FrameworkSingletons,
    ...
    public static ResponseMessageInterface doExportMantisIssues(final ObservatoryInstrumentDAOInterface dao,
                                                                final CommandMessageInterface commandmessage)
        {
        final String SOURCE = "ExportMantisIssues.doExportMantisIssues()";
        ...
        if ((dao.getHostInstrument() != null)
            ...
            // assuming that the Mantis RSS reader has been running???
            ...
            if (((dao.getHostInstrument() != null))
                ...
                {
                final UIComponentPlugin uiMantis;
                final StringBuffer buffer;

                uiMantis = ((CommunicatorInstrumentPanel)dao.getHostInstrument().getInstrumentPanel()).getMantisTab();

                if ((uiMantis != null)
                    && (uiMantis instanceof SimpleNewsreaderPanel))
                    {
                    buffer = new StringBuffer(((SimpleNewsreaderPanel)uiMantis).getNewsText());
