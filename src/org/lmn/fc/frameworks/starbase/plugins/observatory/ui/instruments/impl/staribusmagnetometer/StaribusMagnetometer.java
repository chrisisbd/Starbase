...
/***************************************************************************************************
 * A StaribusMagnetometer.
 */

public final class StaribusMagnetometer extends AbstractObservatoryInstrument
                                        implements ObservatoryInstrumentInterface
    {
    /***********************************************************************************************
     * Construct a StaribusMagnetometer.
     *
     * @param instrument
     * @param plugin
     * @param hostui
    ...
    public StaribusMagnetometer(final Instrument instrument,
    ...
    /***********************************************************************************************
     * Initialise the StaribusMagnetometer.
     */
    ...
    public void initialise()
        ...
        // Read the Resources for the StaribusMagnetometer
        readResources();

        super.initialise();

        // Create and initialise the StaribusMagnetometerControlPanel
        controlPanel = new StaribusMagnetometerControlPanel(this,
                                                            getInstrument(),
                                                            getHostUI(),
        ...
        // Create a StaribusMagnetometerInstrumentPanel and initialise it
        instrumentPanel = new StaribusMagnetometerInstrumentPanel(this,
                                                                  getInstrument(),
                                                                  getHostUI(),
                                                                  (TaskPlugin)getHostAtom().getRootTask(),
                                                                  getFontData(),
    ...
    /* Utilities                                                                                  */
    /***********************************************************************************************
     *  Read all the Resources required by the StaribusMagnetometer.
     */

    public void readResources()
        {
        LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                               "StaribusMagnetometer [ResourceKey=" + getResourceKey() + "]");
