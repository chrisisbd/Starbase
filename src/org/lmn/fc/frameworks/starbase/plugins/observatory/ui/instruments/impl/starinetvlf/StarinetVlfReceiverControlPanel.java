...
/***************************************************************************************************
 * The StarinetVlfReceiverControlPanel.
 */

public final class StarinetVlfReceiverControlPanel extends InstrumentUIComponentDecorator
                                                   implements ControlPanelInterface
    {
    // String Resources
    private static final String ICON_CONTROL = "starinet-vlf-control.png";
    private static final String DEFAULT_FORMAT_0 = "00.0 kHz";
    private static final String DEFAULT_FORMAT_1 = "0000 mV";


    /***********************************************************************************************
     * Construct the StarinetVlfReceiverControlPanel.
     *
     * @param instrument
     * @param instrumentxml
     * @param hostui
    ...
    public StarinetVlfReceiverControlPanel(final ObservatoryInstrumentInterface instrument,
    ...
    public void instrumentChanged(final InstrumentStateChangedEvent event)
        {
        LOGGER.debugIndicators("StarinetVlfReceiverControlPanel.instrumentChanged() --> update indicators");
