...
/***************************************************************************************************
 * The DataProcessorControlPanel.
 */

public final class DataProcessorControlPanel extends InstrumentUIComponentDecorator
                                             implements ControlPanelInterface
    {
    // String Resources
    private static final String ICON_CONTROL = "processor-control.png";


    /***********************************************************************************************
     * Construct the DataProcessorControlPanel.
     *
     * @param instrument
     * @param instrumentxml
     * @param obsui
    ...
    public DataProcessorControlPanel(final ObservatoryInstrumentInterface instrument,
    ...
    public void instrumentChanged(final InstrumentStateChangedEvent event)
        {
        LOGGER.debugIndicators("DataProcessorControlPanel.instrumentChanged() --> update indicators");
