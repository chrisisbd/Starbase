...
public final class ActionsUIComponent extends ReportTable
    ...
    public ActionsUIComponent(final TaskPlugin taskplugin,
    ...
    public synchronized JTable initialiseReport() throws ReportException
        {
        final String SOURCE = "ActionsUIComponent.initialiseReport() ";
                ...
                public void valueChanged(final ListSelectionEvent event)
                    ...
                    if (!modelSelection.isSelectionEmpty())
                        ...
                        if ((getReportTableModel() != null)
                            ...
                            if (vecSelectedRow != null)
                                ...
                                if ((actionDataSelected != null)
                                    ...
                                    if ((objComment != null)
                                        ...
                                        // Archive the current Actions automatically
                                        archiveActions();
                                        }
                                    }
                                }
                            ...
                            {
                            LOGGER.error(SOURCE + "Empty report");
                            }
                        }
                    else
                        {
                        LOGGER.error(SOURCE + "Empty report selection");
                        }
                    }
                });
    ...
    public void archiveActions()
        ...
        try
            {
            // Produce a Report, but overwrite the same one each time
            if ((getTask() != null)
                && (REGISTRY_MODEL != null)
                ...
                //LOGGER.error("ToDo Need a way of archiving the Action List!");
