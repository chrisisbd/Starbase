...
/***************************************************************************************************
 * The StaribusVlfReceiverMK.
 */

public final class StaribusVlfReceiverMK extends AbstractObservatoryInstrument
    ...
    /***********************************************************************************************
     * Construct a StaribusVlfReceiverMK.
     *
     * @param instrument
     * @param plugin
     * @param hostui
    ...
    public StaribusVlfReceiverMK(final Instrument instrument,
    ...
    /***********************************************************************************************
     * Initialise the StaribusVlfReceiverMK.
     */
    ...
    public final void initialise()
        ...
        // Read the Resources for the StaribusVlfReceiverMK
        readResources();
    ...
    /* Utilities                                                                                  */
    /***********************************************************************************************
     * Read all the Resources required by the StaribusVlfReceiverMK.
     */

    public void readResources()
        {
        LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                               "StaribusVlfReceiverMK [ResourceKey=" + getResourceKey() + "]");
