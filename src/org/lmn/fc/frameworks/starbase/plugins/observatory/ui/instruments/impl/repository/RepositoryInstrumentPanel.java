...
package org.lmn.fc.frameworks.starbase.plugins.observatory.ui.instruments.impl.repository;
...
/***************************************************************************************************
 * The RepositoryInstrumentPanel.
 */

public final class RepositoryInstrumentPanel extends InstrumentUIComponentDecorator
    {
    // String Resources
    private static final String ICON_HEADER_REPOSITORY = "repository-header.png";

    private static final String TAB_REPOSITORY = "Repository";
    private static final String INSTRUMENT_HELP = "RepositoryHelp.html";

    private UIComponentPlugin tabRepository;


    /***********************************************************************************************
     * Construct a RepositoryInstrumentPanel.
     *
     * @param instrument
     * @param instrumentxml
     * @param hostui
    ...
    public RepositoryInstrumentPanel(final ObservatoryInstrumentInterface instrument,
    ...
    /***********************************************************************************************
     * Initialise the RepositoryInstrumentPanel.
     */
    ...
    public final void initialiseUI()
        ...
        InstrumentUIHelper.configureInstrumentPanelHeader(getHeaderUIComponent(),
                                                          ...
                                                          getInstrument(),
                                                          ICON_HEADER_REPOSITORY,
                                                          getFontData(),
                                                          getColourData());

        // Create the RepositoryInstrumentPanel and add it to the host UIComponent
    ...
    /* Utilities                                                                                  */
    /***********************************************************************************************
     * Create and initialise the JTabbedPane for the RepositoryInstrumentPanel.
     */
    ...
    /***********************************************************************************************
     * Get the Repository Tab.
     *
     * @return UIComponentPlugin
     */

    public UIComponentPlugin getRepositoryTab()
        {
