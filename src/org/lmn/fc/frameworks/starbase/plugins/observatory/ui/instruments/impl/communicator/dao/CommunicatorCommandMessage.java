...
/***************************************************************************************************
 * CommunicatorCommandMessage.
 */

public final class CommunicatorCommandMessage extends AbstractCommandMessage
    {
    /***********************************************************************************************
     * Construct a CommunicatorCommandMessage.
    ...
    public CommunicatorCommandMessage(final ObservatoryInstrumentDAOInterface dao,
            ...
            if (command.getLegacyCode() != null)
                ...
                if (command.getParameterList().size() == 1)
                    ...
                    if ((parameter.getValue() != null)
                        ...
                        // Map the Parameter to a String appropriate to a CommunicatorCommandMessage
                        ...
                        if (strParameter != null)
                            ...
                            LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                                                   "CommunicatorCommandMessage.buildByteArray() [parameter="
                                                        + strParameter
                                                        + "] [datatype="
                            ...
                            LOGGER.error("CommunicatorCommandMessage.buildByteArray() Invalid ParameterValue");
                            }
                        }
                    else
                        {
                        // Something is wrong with the data we have been given
                        LOGGER.error("CommunicatorCommandMessage.buildByteArray() Invalid Parameter");
                        }
                    }
                else
                    {
                    LOGGER.error("CommunicatorCommandMessage.buildByteArray() Command has an incorrect number of Parameters");
                    }
                }
            else
                {
                LOGGER.error("CommunicatorCommandMessage.buildByteArray() Command does not have a LegacyCode");
                }
            }
        else
            {
