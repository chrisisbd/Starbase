...
/***************************************************************************************************
 * AOR8600CommandMessage.
 */

public final class AOR8600CommandMessage extends AbstractCommandMessage
    {
    /***********************************************************************************************
     * Construct a AOR8600CommandMessage.
    ...
    public AOR8600CommandMessage(final ObservatoryInstrumentDAOInterface dao,
            ...
            if (command.getLegacyCode() != null)
                ...
                if (command.getParameterList().size() == 1)
                    ...
                    if ((parameter.getValue() != null)
                        ...
                        // Map the Parameter to a String appropriate to a AOR8600CommandMessage
                        ...
                        if (strParameter != null)
                            ...
                            LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                                                   "AOR8600CommandMessage.buildByteArray() [parameter="
                                            + strParameter
                                            + "] [datatype="
                            ...
                            LOGGER.error("AOR8600CommandMessage.buildByteArray() Invalid ParameterValue");
                            }
                        }
                    else
                        {
                        // Something is wrong with the data we have been given
                        LOGGER.error("AOR8600CommandMessage.buildByteArray() Invalid Parameter");
                        }
                    }
                else
                    {
                    LOGGER.error("AOR8600CommandMessage.buildByteArray() Command has an incorrect number of Parameters");
                    }
                }
            else
                {
                LOGGER.error("AOR8600CommandMessage.buildByteArray() Command does not have a LegacyCode");
                }
            }
        else
            {
