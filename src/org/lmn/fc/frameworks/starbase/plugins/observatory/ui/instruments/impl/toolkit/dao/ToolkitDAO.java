...
public final class ToolkitDAO extends AbstractObservatoryInstrumentDAO
    ...
    /***********************************************************************************************
     * Construct a ToolkitRxDAO.
     *
     * @param hostinstrument
     */

    public ToolkitDAO(final ObservatoryInstrumentInterface hostinstrument)
        {
    ...
    public boolean initialiseDAO(final String resourcekey)
        ...
        LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                               "ToolkitRxDAO.initialiseDAO() [resourcekey=" + resourcekey + "]");
    ...
    public CommandMessageInterface constructCommandMessage(final ObservatoryInstrumentDAOInterface dao,
        ...
        {
        return (new ToolkitCommandMessage(dao,
                                          instrumentxml,
                                          module,
                                          command,
                                          starscript.trim()));
    ...
    public ResponseMessageInterface constructResponseMessage(final String portname,
        ...
        {
        return (new ToolkitResponseMessage(portname,
                                           instrumentxml,
                                           module,
                                           command,
                                           starscript.trim(),
    ...
    /***********************************************************************************************
     * Read all the Resources required by the ToolkitRxDAO.
     *
    ...
    public void readResources()
        {
        LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                               "ToolkitRxDAO.readResources() [ResourceKey=" + getResourceKey() + "]");
