...
public final class RepositoryResponseMessage extends AbstractResponseMessage
    {
    /***********************************************************************************************
     * Construct a RepositoryResponseMessage.
    ...
    public RepositoryResponseMessage(final String portname,
...
//            && (XmlBeansUtilities.isValidXml(command))
    ...
    /***********************************************************************************************
     * Parse a byte array, attempting to find a RepositoryResponseMessage
