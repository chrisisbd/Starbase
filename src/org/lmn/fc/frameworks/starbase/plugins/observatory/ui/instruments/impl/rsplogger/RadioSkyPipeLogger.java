...
/***************************************************************************************************
 * The RadioSkyPipeLogger.
 */

public final class RadioSkyPipeLogger extends AbstractObservatoryInstrument
    ...
    /***********************************************************************************************
     * Construct a RadioSkyPipeLogger.
     *
     * @param instrument
     * @param plugin
     * @param hostui
    ...
    public RadioSkyPipeLogger(final Instrument instrument,
    ...
    /***********************************************************************************************
     * Initialise the RadioSkyPipeLogger.
     */
    ...
    public final void initialise()
        ...
        // Read the Resources for the RadioSkyPipeLogger
        readResources();
        ...
        controlPanel = new RadioSkyPipeLoggerControlPanel(this,
                                                          getInstrument(),
                                                          getHostUI(),
        ...
        // Create an RadioSkyPipeLoggerInstrumentPanel and initialise it
        instrumentPanel = new RadioSkyPipeLoggerInstrumentPanel(this,
                                                                getInstrument(),
                                                                getHostUI(),
                                                                (TaskPlugin)getHostAtom().getRootTask(),
                                                                getFontData(),
    ...
    /* Utilities                                                                                  */
    /***********************************************************************************************
     * Read all the Resources required by the RadioSkyPipeLogger.
     */

    public void readResources()
        {
        LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                               "RadioSkyPipeLogger [ResourceKey=" + getResourceKey() + "]");
