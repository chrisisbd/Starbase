...
public final class AntennaTester extends AbstractObservatoryInstrument
                                 implements ObservatoryInstrumentInterface
    {
    /***********************************************************************************************
     * Construct an AntennaTester.
     *
     * @param instrument
     * @param plugin
     * @param hostui
    ...
    public AntennaTester(final Instrument instrument,
    ...
    public final void initialise()
        ...
        // Read the Resources for the AntennaTester
        readResources();

        // Set up the Instrument
        super.initialise();

        // Create and initialise the AntennaTester ControlPanel
        controlPanel = new AntennaTesterControlPanel(this,
                                                     getInstrument(),
                                                     getHostUI(),
        ...
        // Create an AntennaTester InstrumentPanel and initialise it
        instrumentPanel = new AntennaTesterInstrumentPanel(this,
                                                           getInstrument(),
                                                           getHostUI(),
                                                           (TaskPlugin)getHostAtom().getRootTask(),
                                                           getFontData(),
    ...
    /* Utilities                                                                                  */
    /***********************************************************************************************
     * Read all the Resources required by the AntennaTester.
     */

    public void readResources()
        {
        LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                               "AntennaTester [ResourceKey=" + getResourceKey() + "]");
