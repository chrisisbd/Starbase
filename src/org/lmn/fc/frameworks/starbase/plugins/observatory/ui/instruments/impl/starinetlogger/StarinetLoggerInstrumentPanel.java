...
public final class StarinetLoggerInstrumentPanel extends InstrumentUIComponentDecorator
    {
    // String Resources
    private static final String ICON_HEADER = "starinet-logger-header.png";
    private static final String INSTRUMENT_HELP = "StarinetLoggerHelp.html";
    ...
    public StarinetLoggerInstrumentPanel(final ObservatoryInstrumentInterface instrument,
    ...
    public void instrumentChanged(final InstrumentStateChangedEvent event)
        {
        final String SOURCE = "StarinetLoggerInstrumentPanel.instrumentChanged() ";
    ...
    private void createAndInitialiseTabs()
        {
        final String SOURCE = "StarinetLoggerInstrumentPanel.createAndInitialiseTabs() ";
