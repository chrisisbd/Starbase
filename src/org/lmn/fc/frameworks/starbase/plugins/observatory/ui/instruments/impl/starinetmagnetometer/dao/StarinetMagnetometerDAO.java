...
package org.lmn.fc.frameworks.starbase.plugins.observatory.ui.instruments.impl.starinetmagnetometer.dao;
...
public final class StarinetMagnetometerDAO extends StaribusCoreDAO
    ...
    /***********************************************************************************************
     * Construct a StarinetMagnetometerDAO.
     *
     * @param hostinstrument
     */

    public StarinetMagnetometerDAO(final ObservatoryInstrumentInterface hostinstrument)
        {
    ...
    public boolean initialiseDAO(final String resourcekey)
        {
        final String SOURCE = "StarinetMagnetometerDAO.initialiseDAO() ";
    ...
    public ResponseMessageInterface captureRawDataRealtime(final CommandMessageInterface commandmessage)
        {
        final String SOURCE = "StarinetMagnetometerDAO.captureRawDataRealtime()";
        ...
        return (CaptureCommandHelper.doIteratedStaribusMultichannelDataCaptureCommand(this,
                                                                                      commandmessage,
                                                                                      StaribusHelper.createMultichannelChartLegendMetadata("Starinet Magnetometer Logger",
                                                                                                                                           "Time (UT)",
    ...
    public ResponseMessageInterface publishChartRealtime(final CommandMessageInterface commandmessage)
        {
        final String SOURCE = "StarinetMagnetometerDAO.publishChartRealtime() ";

        return (PublishRealtime.doPublishChartRealtime(this,
                                                       commandmessage,
                                                       StaribusHelper.createMultichannelChartLegendMetadata("Starinet Magnetometer Publisher",
                                                                                                            "Time (UT)",
                                                                                                            "Magnetometer Outputs"),
                                                       SOURCE,
                                                       false));
    ...
    public ResponseMessageInterface publishChartRealtimeDay(final CommandMessageInterface commandmessage)
        {
        final String SOURCE = "StarinetMagnetometerDAO.publishChartRealtimeDay() ";
    ...
    public ResponseMessageInterface getStarinetAddress(final CommandMessageInterface commandmessage)
        {
        final String SOURCE = "StarinetMagnetometerDAO.getStarinetAddress() ";
    ...
    public ResponseMessageInterface writeCommandMap(final CommandMessageInterface commandmessage)
        {
        final String SOURCE = "StarinetMagnetometerDAO.writeCommandMap() ";
    ...
    public void readResources()
        {
        final String SOURCE = "StarinetMagnetometerDAO.readResources() ";

        //LOGGER.debugTimedEvent("StarinetMagnetometerDAO.readResources() [ResourceKey=" + getResourceKey() + "]");
