...
package org.lmn.fc.frameworks.starbase.plugins.observatory.ui.instruments.impl.repository.dao;
...
/***************************************************************************************************
 * RepositoryCommandMessage.
 */

public final class RepositoryCommandMessage extends AbstractCommandMessage
    {
    /***********************************************************************************************
     * Construct a RepositoryCommandMessage.
    ...
    public RepositoryCommandMessage(final ObservatoryInstrumentDAOInterface dao,
            ...
            if (command.getLegacyCode() != null)
                ...
                if (command.getParameterList().size() == 1)
                    ...
                    if ((parameter.getValue() != null)
                        ...
                        // Map the Parameter to a String appropriate to a RepositoryCommandMessage
                        ...
                        if (strParameter != null)
                            ...
                            LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                                                   "RepositoryCommandMessage.buildByteArray() [parameter="
                                                        + strParameter
                                                        + "] [datatype="
                            ...
                            LOGGER.error("RepositoryCommandMessage.buildByteArray() Invalid ParameterValue");
                            }
                        }
                    else
                        {
                        // Something is wrong with the data we have been given
                        LOGGER.error("RepositoryCommandMessage.buildByteArray() Invalid Parameter");
                        }
                    }
                else
                    {
                    LOGGER.error("RepositoryCommandMessage.buildByteArray() Command has an incorrect number of Parameters");
                    }
                }
            else
                {
                LOGGER.error("RepositoryCommandMessage.buildByteArray() Command does not have a LegacyCode");
                }
            }
        else
            {
