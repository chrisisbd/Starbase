...
/***************************************************************************************************
 * ObservatoryExplorerCommandMessage.
 */

public final class ObservatoryExplorerCommandMessage extends AbstractCommandMessage
    {
    /***********************************************************************************************
     * Construct a ObservatoryExplorerCommandMessage.
    ...
    public ObservatoryExplorerCommandMessage(final ObservatoryInstrumentDAOInterface dao,
            ...
            if (command.getLegacyCode() != null)
                ...
                if (command.getParameterList().size() == 1)
                    ...
                    if ((parameter.getValue() != null)
                        ...
                        // Map the Parameter to a String appropriate to a ObservatoryExplorerCommandMessage
                        ...
                        if (strParameter != null)
                            ...
                            LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                                                   "ObservatoryExplorerCommandMessage.buildByteArray() [parameter="
                                                        + strParameter
                                                        + "] [datatype="
                            ...
                            LOGGER.error("ObservatoryExplorerCommandMessage.buildByteArray() Invalid ParameterValue");
                            }
                        }
                    else
                        {
                        // Something is wrong with the data we have been given
                        LOGGER.error("ObservatoryExplorerCommandMessage.buildByteArray() Invalid Parameter");
                        }
                    }
                else
                    {
                    LOGGER.error("ObservatoryExplorerCommandMessage.buildByteArray() Command has an incorrect number of Parameters");
                    }
                }
            else
                {
                LOGGER.error("ObservatoryExplorerCommandMessage.buildByteArray() Command does not have a LegacyCode");
                }
            }
        else
            {
