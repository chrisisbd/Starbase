...
/***************************************************************************************************
 * NtpClientInstrumentPanel.
 */

public final class NtpClientInstrumentPanel extends InstrumentUIComponentDecorator
    {
    // String Resources
    private static final String ICON_HEADER = "ntp-header.png";

    private static final String TAB_CHART = "Clock Offset";

    private static final String INSTRUMENT_HELP = "NtpHelp.html";


    /***********************************************************************************************
     * Construct an NtpClientInstrumentPanel.
     *
     * @param instrument
     * @param instrumentxml
     * @param hostui
    ...
    public NtpClientInstrumentPanel(final ObservatoryInstrumentInterface instrument,
    ...
    /***********************************************************************************************
     * Initialise the NtpClientInstrumentPanel.
     */
    ...
    public final void initialiseUI()
        ...
        // Create the NtpClientInstrumentPanel and add it to the host UIComponent
    ...
    /* Utilities                                                                                  */
    /***********************************************************************************************
     * Create and initialise the JTabbedPane for the NtpClientInstrumentPanel.
     */
    ...
    private void createAndInitialiseTabs()
        ...
        InstrumentPanelTabFactory.addNTPInstrumentLogTab(this,
                                                         TAB_INSTRUMENT_LOG,
                                                         REGISTRY_MODEL.getLoggedInUser());
