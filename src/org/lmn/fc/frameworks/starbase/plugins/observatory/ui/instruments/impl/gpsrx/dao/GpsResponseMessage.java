...
public final class GpsResponseMessage extends AbstractResponseMessage
    {
    /***********************************************************************************************
     * Construct a GpsResponseMessage.
    ...
    public GpsResponseMessage(final String portname,
...
//            && (XmlBeansUtilities.isValidXml(command))
    ...
    /***********************************************************************************************
     * Parse a byte array, attempting to find a GpsResponseMessage
