...
/***************************************************************************************************
 * The AntennaTesterControlPanel.
 */

public final class AntennaTesterControlPanel extends InstrumentUIComponentDecorator
                                             implements ControlPanelInterface
    {
    // String Resources
    private static final String ICON_CONTROL = "antenna-control.png";


    /***********************************************************************************************
     * Construct the AntennaTesterControlPanel.
     *
     * @param instrument
     * @param instrumentxml
     * @param hostui
    ...
    public AntennaTesterControlPanel(final ObservatoryInstrumentInterface instrument,
    ...
    public void instrumentChanged(final InstrumentStateChangedEvent event)
        {
        //LOGGER.debugIndicators("AntennaTesterControlPanel.instrumentChanged() --> update indicators");
