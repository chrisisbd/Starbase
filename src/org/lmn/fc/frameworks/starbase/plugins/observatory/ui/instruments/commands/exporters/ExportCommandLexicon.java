...
public final class ExportCommandLexicon implements FrameworkConstants,
                                                   FrameworkStrings,
                                                   FrameworkMetadata,
                                                   FrameworkSingletons,
    ...
    public static ResponseMessageInterface doExportCommandLexicon(final ObservatoryInstrumentDAOInterface dao,
                                                                  final CommandMessageInterface commandmessage)
        {
        final String SOURCE = "ExportCommandLexicon.exportCommandLexicon()";

        // The CommandLexicon is found via the Instrument's CommandProcessorContext
        if ((dao.getHostInstrument().getContext() != null)
            && (dao.getHostInstrument().getContext().getCommandLexicon() != null))
            {
            return (dao.exportReportTable(SOURCE,
                                          ...
                                          true,
                                          DatasetType.TABULAR,
                                          dao.getHostInstrument().getContext().getCommandLexicon()));
            }
        else
            {
