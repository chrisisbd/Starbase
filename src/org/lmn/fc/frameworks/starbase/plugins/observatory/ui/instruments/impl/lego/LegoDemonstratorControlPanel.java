...
/***************************************************************************************************
 * The LegoDemonstratorControlPanel.
 */

public final class LegoDemonstratorControlPanel extends InstrumentUIComponentDecorator
                                                implements ControlPanelInterface
    {
    // String Resources
    private static final String ICON_CONTROL = "lego-demonstrator-control.png";

    private static final long serialVersionUID = 4335207377203784819L;


    /***********************************************************************************************
     * Construct the LegoDemonstratorControlPanel.
     *
     * @param instrument
     * @param instrumentxml
     * @param hostui
    ...
    public LegoDemonstratorControlPanel(final ObservatoryInstrumentInterface instrument,
    ...
    public void instrumentChanged(final InstrumentStateChangedEvent event)
        {
        LOGGER.debugIndicators("LegoDemonstratorControlPanel.instrumentChanged() --> update indicators");
