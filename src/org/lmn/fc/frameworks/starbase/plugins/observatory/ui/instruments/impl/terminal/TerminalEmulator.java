...
public final class TerminalEmulator extends AbstractObservatoryInstrument
    ...
    public TerminalEmulator(final Instrument instrument,
    ...
    public void initialise()
        ...
        // Read the Resources for the TerminalEmulator
        readResources();

        super.initialise();

        // Create and initialise the TerminalEmulatorControlPanel
        controlPanel = new TerminalEmulatorControlPanel(this,
                                                        getInstrument(),
                                                        getHostUI(),
        ...
        instrumentPanel = new TerminalEmulatorInstrumentPanel(this,
                                                              getInstrument(),
                                                              getHostUI(),
                                                              (TaskPlugin)getHostAtom().getRootTask(),
                                                              getFontData(),
    ...
    public void readResources()
        ...
        LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                               "TerminalEmulator [ResourceKey=" + getResourceKey() + "]");
