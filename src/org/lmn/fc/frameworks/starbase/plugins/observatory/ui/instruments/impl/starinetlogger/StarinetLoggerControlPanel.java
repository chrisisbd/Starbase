...
public final class StarinetLoggerControlPanel extends InstrumentUIComponentDecorator
    ...
    public StarinetLoggerControlPanel(final ObservatoryInstrumentInterface instrument,
...
//        InstrumentUIHelper.assembleControlPanel(this, this, ICON_CONTROL);
    ...
    public void instrumentChanged(final InstrumentStateChangedEvent event)
        {
        LOGGER.debugIndicators("StarinetLoggerControlPanel.instrumentChanged() --> update indicators");
