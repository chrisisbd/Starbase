...
/***************************************************************************************************
 * The SpectraCyberClientControlPanel.
 */

public final class SpectraCyberClientControlPanel extends InstrumentUIComponentDecorator
    ...
    /***********************************************************************************************
     * Construct the SpectraCyberClientControlPanel.
     *
     * @param instrument
     * @param oui
     * @param instrumentxml
    ...
    public SpectraCyberClientControlPanel(final ObservatoryInstrumentInterface instrument,
    ...
    public void instrumentChanged(final InstrumentStateChangedEvent event)
        {
        LOGGER.debugIndicators("SpectraCyberClientControlPanel.instrumentChanged() --> update indicators");
