...
/***************************************************************************************************
 * The FunCubeDongleRxControlPanel.
 */

public final class FunCubeDongleRxControlPanel extends InstrumentUIComponentDecorator
                                               implements ControlPanelInterface
    {
    // String Resources
    private static final String ICON_CONTROL = "fcdrx-control.png";


    /***********************************************************************************************
     * Construct the FunCubeDongleRxControlPanel.
     *
     * @param instrument
     * @param oui
     * @param instrumentxml
    ...
    public FunCubeDongleRxControlPanel(final ObservatoryInstrumentInterface instrument,
    ...
    public void instrumentChanged(final InstrumentStateChangedEvent event)
        {
        LOGGER.debugIndicators("FunCubeDongleRxControlPanel.instrumentChanged() --> update indicators");
