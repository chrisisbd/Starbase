...
/***************************************************************************************************
 * ByVacDemonstratorTxStream.
 */

public final class ByVacDemonstratorTxStream extends AbstractTxStream
                                             implements PortTxStreamInterface
    {
    // The ByVacDemonstrator RS232 port
    private SerialPort serialPort;

    // ByVacDemonstratorTxStream Stream Resources
    ...
    /***********************************************************************************************
     * Construct a ByVacDemonstratorTxStream.
     *
     * @param resourcekey
     */

    public ByVacDemonstratorTxStream(final String resourcekey)
        {
        super(resourcekey);
    ...
    public boolean open() throws IOException
        ...
        LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                               "ByVacDemonstratorTxStream.open()");
        ...
        try
            ...
            if (getSerialPort() != null)
                ...
                if (getLoopbackRxStream() instanceof SerialPortEventListener)
                    ...
                    {
                    LOGGER.error("ByVacDemonstratorTxStream.open() LoopbackStream is not a SerialPortEventListener");
                    }
                }
            }
            ...
            {
            throw new IOException("ByVacDemonstratorTxStream.open()", exception);
            }
    ...
    public void close() throws IOException
        {
        LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                               "ByVacDemonstratorTxStream.close()");
    ...
    public void reset()
        {
        LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                               "ByVacDemonstratorTxStream.reset()");
        }
    ...
    public final void write(final InstrumentsDocument instrumentsdoc,
        ...
        if ((getSerialPort() != null)
            ...
            && (isStreamOpen()))
            {
            //LOGGER.debugProtocolEvent("ByVacDemonstratorTxStream.write() sending bytes=[" + Utilities.byteArrayToExpandedAscii(commandmessage.getByteArray()) +"]");
            //LOGGER.debugProtocolEvent("ByVacDemonstratorTxStream.write() sending String=[" + new String(commandmessage.getByteArray()) +"]");
            ...
            LOGGER.debugCommandEvent(LOADER_PROPERTIES.isStaribusDebug(),
                                      "ByVacDemonstratorTxStream.write() ERROR Unable to transmit");
            }
        }
    ...
    public final void readResources()
        {
        //LOGGER.debugProtocolEvent("ByVacDemonstratorTxStream.readResources() [ResourceKey=" + getResourceKey() + "]");
