...
public final class ByVacDemonstrator extends AbstractObservatoryInstrument
                                     implements ObservatoryInstrumentInterface
    {
    /***********************************************************************************************
     * Construct a ByVacDemonstrator.
     *
     * @param instrument
     * @param plugin
     * @param hostui
    ...
    public ByVacDemonstrator(final Instrument instrument,
    ...
    /***********************************************************************************************
     * Initialise the ByVacDemonstrator.
     */
    ...
    public void initialise()
        ...
        // Read the Resources for the ByVacDemonstrator
        readResources();

        super.initialise();

        // Create and initialise the ControlPanel
        controlPanel = new ByVacDemonstratorControlPanel(this,
                                                         getInstrument(),
                                                         getHostUI(),
        ...
        instrumentPanel = new ByVacDemonstratorInstrumentPanel(this,
                                                               getInstrument(),
                                                               getHostUI(),
                                                               (TaskPlugin)getHostAtom().getRootTask(),
                                                               getFontData(),
    ...
    /* Utilities                                                                                  */
    /***********************************************************************************************
     *  Read all the Resources required by the ByVacDemonstrator.
     */

    public void readResources()
        {
        LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                               "ByVacDemonstrator [ResourceKey=" + getResourceKey() + "]");
