...
/***************************************************************************************************
 * The ObservatoryInstaller.
 */

public final class ObservatoryInstaller extends AbstractObservatoryInstrument
                                        implements ObservatoryInstrumentInterface
    {
    /***********************************************************************************************
     * Construct a ObservatoryInstaller.
     *
     * @param instrument
     * @param plugin
     * @param hostui
    ...
    public ObservatoryInstaller(final Instrument instrument,
    ...
    /***********************************************************************************************
     * Initialise the ObservatoryInstaller.
     */
    ...
    public final void initialise()
        ...
        // Read the Resources for the ObservatoryInstaller
        readResources();
        ...
        controlPanel = new ObservatoryInstallerControlPanel(this,
                                                            getInstrument(),
                                                            getHostUI(),
        ...
        instrumentPanel = new ObservatoryInstallerInstrumentPanel(this,
                                                                  getInstrument(),
                                                                  getHostUI(),
                                                                  (TaskPlugin)getHostAtom().getRootTask(),
                                                                  getFontData(),
    ...
    /* Utilities                                                                                  */
    /***********************************************************************************************
     * Read all the Resources required by the ObservatoryInstaller.
     */

    public void readResources()
        {
        LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                               "ObservatoryInstaller [ResourceKey=" + getResourceKey() + "]");
