...
/***************************************************************************************************
 * The SpectraCyberServerControlPanel.
 */

public final class SpectraCyberServerControlPanel extends InstrumentUIComponentDecorator
                                                  implements ControlPanelInterface
    {
    // String Resources
    private static final String ICON_CONTROL = "spectracyber-control.png";


    /***********************************************************************************************
     * Construct the SpectraCyberServerControlPanel.
     *
     * @param instrument
     * @param oui
     * @param instrumentxml
    ...
    public SpectraCyberServerControlPanel(final ObservatoryInstrumentInterface instrument,
    ...
    public void instrumentChanged(final InstrumentStateChangedEvent event)
        {
        LOGGER.debugIndicators("SpectraCyberServerControlPanel.instrumentChanged() --> update indicators");
