...
package org.lmn.fc.frameworks.starbase.plugins.observatory.ui.instruments.impl.rsplogger.dao;
...
/***************************************************************************************************
 * RadioSkyPipeLoggerCommandMessage.
 */

public final class RadioSkyPipeLoggerCommandMessage extends AbstractCommandMessage
    {
    /***********************************************************************************************
     * Construct a RadioSkyPipeLoggerCommandMessage.
    ...
    public RadioSkyPipeLoggerCommandMessage(final ObservatoryInstrumentDAOInterface dao,
            ...
            if (command.getLegacyCode() != null)
                ...
                if (command.getParameterList().size() == 1)
                    ...
                    if ((parameter.getValue() != null)
                        ...
                        // Map the Parameter to a String appropriate to a RadioSkyPipeLoggerCommandMessage
                        ...
                        if (strParameter != null)
                            ...
                            LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                                                   "RadioSkyPipeLoggerCommandMessage.buildByteArray() [parameter="
                                                        + strParameter
                                                        + "] [datatype="
                            ...
                            LOGGER.error("RadioSkyPipeLoggerCommandMessage.buildByteArray() Invalid ParameterValue");
                            }
                        }
                    else
                        {
                        // Something is wrong with the data we have been given
                        LOGGER.error("RadioSkyPipeLoggerCommandMessage.buildByteArray() Invalid Parameter");
                        }
                    }
                else
                    {
                    LOGGER.error("RadioSkyPipeLoggerCommandMessage.buildByteArray() Command has an incorrect number of Parameters");
                    }
                }
            else
                {
                LOGGER.error("RadioSkyPipeLoggerCommandMessage.buildByteArray() Command does not have a LegacyCode");
                }
            }
        else
            {
