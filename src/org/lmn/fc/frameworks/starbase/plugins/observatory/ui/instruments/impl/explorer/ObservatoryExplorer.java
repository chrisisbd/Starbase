...
/***************************************************************************************************
 * The ObservatoryExplorer.
 */

public final class ObservatoryExplorer extends AbstractObservatoryInstrument
                                       implements ObservatoryInstrumentInterface
    {
    /***********************************************************************************************
     * Construct a ObservatoryExplorer.
     *
     * @param instrument
     * @param plugin
     * @param hostui
    ...
    public ObservatoryExplorer(final Instrument instrument,
    ...
    /***********************************************************************************************
     * Initialise the ObservatoryExplorer.
     */
    ...
    public final void initialise()
        ...
        // Read the Resources for the ObservatoryExplorer
        readResources();
        ...
        controlPanel = new ObservatoryExplorerControlPanel(this,
                                                           getInstrument(),
                                                           getHostUI(),
        ...
        instrumentPanel = new ObservatoryExplorerInstrumentPanel(this,
                                                                 getInstrument(),
                                                                 getHostUI(),
                                                                 (TaskPlugin)getHostAtom().getRootTask(),
                                                                 getFontData(),
    ...
    /* Utilities                                                                                  */
    /***********************************************************************************************
     * Read all the Resources required by the ObservatoryExplorer.
     */

    public void readResources()
        {
        LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                               "ObservatoryExplorer [ResourceKey=" + getResourceKey() + "]");

        // Read the Font and Colour
        super.readResources();
        }
    }
