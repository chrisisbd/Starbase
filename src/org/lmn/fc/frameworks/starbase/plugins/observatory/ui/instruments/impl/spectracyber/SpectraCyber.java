...
public final class SpectraCyber extends AbstractObservatoryInstrument
                                implements ObservatoryInstrumentInterface
    {
    /***********************************************************************************************
     * Construct a SpectraCyber.
     *
     * @param instrument
     * @param plugin
     * @param hostui
    ...
    public SpectraCyber(final Instrument instrument,
    ...
    public void initialise()
        ...
        // Read the Resources for the SpectraCyber
        readResources();

        super.initialise();

        // Create and initialise the ControlPanel
        controlPanel = new SpectraCyberControlPanel(this,
                                                    getInstrument(),
                                                    getHostUI(),
        ...
        instrumentPanel = new SpectraCyberInstrumentPanel(this,
                                                          getInstrument(),
                                                          getHostUI(),
                                                          (TaskPlugin)getHostAtom().getRootTask(),
                                                          getFontData(),
    ...
    /* Utilities                                                                                  */
    /***********************************************************************************************
     *  Read all the Resources required by the SpectraCyber.
     */

    public void readResources()
        {
        LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                               "SpectraCyber [ResourceKey=" + getResourceKey() + "]");
