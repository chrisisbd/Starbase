...
public final class WorldMagneticModel
     ...
     *   In the WorldMagneticModel Class, the columns in this file are as follows:
     *   n, m,      gnm,      hnm,       dgnm,      dhnm
     */
//    private String [] input2005 =
...
//    };
    ...
    private final String [] input2010 =
        {
        ...
        private final String [] INPUT = input2010;
    /**
     ...
     * 	by default.
     */
    private static final double currentFixedDate = 2007;
     ...
     */
    private static final double currentFixedAltitude = 0;
    ...
    public static void main(final String [] args)
    {
        ...
        final WorldMagneticModel testCase = new WorldMagneticModel();
        ...
        for(int i=-45; i<55; i+=15)
        {
            for(int j=-180; j<180; j+=60)
            {
                for(int k=0; k<200; k+=100)
                {
                    ...
                    System.out.println("    The total intensity is: " + testCase.getTotalIntensity(i, j, date, k) + " nT.");
...
//            final String message = new String(e.toString());
            //			outputArea.setText(message);
            //			System.err.println("Error:  " + message);

//            System.out.println("\n!NOTICE      NOTICE      NOTICE      ");
//            System.out.println("Error:  " + message);
//            System.out.println("Error in WorldMagneticModel.InitModel()");
...
//            System.out.println("The magnetic field components are set to internal values.");
    ...
    private void calcGeoMag(final double fLat, final double fLon, final double year, final double altitude)
    {
     ...
     * @return
     */
    public double getDeclination( final double dlat, final double dlong )
    {
        if( inputError)
        {
            return 0.0;
     ...
     * @return
     */
    public double getDeclination( final double dlat, final double dlong, final double year, final double altitude )
    {
        if( inputError)
        {
            return 0.0;
     ...
     * @return
     */
    public double getIntensity( final double dlat, final double dlong )
    {
        if( inputError)
        {
            return 0.0;
     ...
     * @return
     */
    public double getTotalIntensity( final double dlat, final double dlong, final double year, final double altitude )
    {
        if( inputError)
        {
            return 0.0;
     ...
     * @return
     */
    public double getHorizontalIntensity( final double dlat, final double dlong )
    {
        if( inputError)
        {
            return 0.0;
     ...
     * @return
     */
    public double getHorizontalIntensity( final double dlat, final double dlong, final double year, final double altitude )
    {
        if( inputError)
        {
            return 0.0;
     ...
     * @return
     */
    public double getVerticalIntensity( final double dlat, final double dlong )
    {
        if( inputError)
        {
            return 0.0;
     ...
     * @return
     */
    public double getVerticalIntensity( final double dlat, final double dlong, final double year, final double altitude )
    {
        if( inputError)
        {
            return 0.0;
     ...
     * @return
     */
    public double getNorthIntensity( final double dlat, final double dlong )
    {
        if( inputError)
        {
            return 0.0;
     ...
     * @return
     */
    public double getNorthIntensity( final double dlat, final double dlong, final double year, final double altitude )
    {
        if( inputError)
        {
            return 0.0;
     ...
     * @return
     */
    public double getEastIntensity( final double dlat, final double dlong )
    {
        if( inputError)
        {
            return 0.0;
     ...
     * @return
     */
    public double getEastIntensity( final double dlat, final double dlong, final double year, final double altitude )
    {
        if( inputError)
        {
            return 0.0;
     ...
     * @return
     */
    public double getDip( final double dlat, final double dlong )
    {
        if( inputError)
        {
            return 0.0;
     ...
     * @return
     */
    public double getDip( final double dlat, final double dlong, final double year, final double altitude )
    {
        if( inputError)
        {
            return 0.0;
    ...
    /**	This method sets the input data to the internal coefficents.
    ...
    private void setCoeff()
    {
        ...
        epoch = Double.valueOf(parser.nextToken());
        //System.out.println("Epoch is: " + epoch);
        final String strModel = parser.nextToken();
        ...
        for(int i=1; i< INPUT.length; i++)
        {
            ...
            gnm = Double.valueOf(parser.nextToken());
            hnm = Double.valueOf(parser.nextToken());
            dgnm = Double.valueOf(parser.nextToken());
            dhnm = Double.valueOf(parser.nextToken());
