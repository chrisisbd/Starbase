...
public final class StarinetTester extends AbstractObservatoryInstrument
                                  implements ObservatoryInstrumentInterface
    {
    /***********************************************************************************************
     * Construct a StarinetTester.
     *
     * @param instrument
     * @param plugin
     * @param hostui
    ...
    public StarinetTester(final Instrument instrument,
    ...
    public final void initialise()
        ...
        // Read the Resources for the StarinetTester
        readResources();

        // Set up the Instrument
        super.initialise();

        // Create and initialise the StarinetTester ControlPanel
        controlPanel = new StarinetTesterControlPanel(this,
                                                      getInstrument(),
                                                      getHostUI(),
        ...
        // Create an StarinetTester InstrumentPanel and initialise it
        instrumentPanel = new StarinetTesterInstrumentPanel(this,
                                                            getInstrument(),
                                                            getHostUI(),
                                                            (TaskPlugin)getHostAtom().getRootTask(),
                                                            getFontData(),
    ...
    /* Utilities                                                                                  */
    /***********************************************************************************************
     * Read all the Resources required by the StarinetTester.
     */

    public void readResources()
        {
        LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                               "StarinetTester [ResourceKey=" + getResourceKey() + "]");
