...
public final class HydrogenReceiver extends AbstractObservatoryInstrument
                                    implements ObservatoryInstrumentInterface
    {
    /***********************************************************************************************
     * Construct a HydrogenReceiver.
     *
     * @param instrument
     * @param plugin
     * @param hostui
    ...
    public HydrogenReceiver(final Instrument instrument,
    ...
    /***********************************************************************************************
     * Initialise the HydrogenReceiver.
     */
    ...
    public void initialise()
        ...
        // Read the Resources for the HydrogenReceiver
        readResources();

        super.initialise();

        // Create and initialise the ControlPanel
        controlPanel = new HydrogenControlPanel(this,
                                                getInstrument(),
                                                getHostUI(),
        ...
        // Create a HydrogenInstrumentPanel and initialise it
        instrumentPanel = new HydrogenInstrumentPanel(this,
                                                      getInstrument(),
                                                      getHostUI(),
                                                      (TaskPlugin)getHostAtom().getRootTask(),
                                                      getFontData(),
    ...
    /* Utilities                                                                                  */
    /***********************************************************************************************
     *  Read all the Resources required by the HydrogenReceiver.
     */

    public void readResources()
        {
        LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                               "HydrogenReceiver [ResourceKey=" + getResourceKey() + "]");
