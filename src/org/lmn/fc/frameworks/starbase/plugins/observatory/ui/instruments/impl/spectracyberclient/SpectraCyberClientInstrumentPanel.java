...
package org.lmn.fc.frameworks.starbase.plugins.observatory.ui.instruments.impl.spectracyberclient;
...
/***************************************************************************************************
 * The SpectraCyberClientInstrumentPanel.
 */

public final class SpectraCyberClientInstrumentPanel extends InstrumentUIComponentDecorator
    {
    // String Resources
    private static final String ICON_HEADER = "spectracyber-header.png";

    private static final String INSTRUMENT_HELP = "SpectraCyberHelp.html";

    private static final double CHART_SC_MIN_VALUE = 0.0;
    private static final double CHART_SC_MAX_VALUE = 4095.0;


    /***********************************************************************************************
     * Construct a SpectraCyberClientInstrumentPanel.
     *
     * @param instrument
     * @param instrumentxml
     * @param oui
    ...
    public SpectraCyberClientInstrumentPanel(final ObservatoryInstrumentInterface instrument,
    ...
    /***********************************************************************************************
     * Initialise the SpectraCyberClientInstrumentPanel.
     */
    ...
    public final void initialiseUI()
        ...
        // Create the SpectraCyberClientInstrumentPanel and add it to the host UIComponent
    ...
    /* Utilities                                                                                  */
    /***********************************************************************************************
     * Create and initialise the JTabbedPane for the SpectraCyberClientInstrumentPanel.
     */
    ...
    private void createAndInitialiseTabs()
        ...
        // Added at EXPORTABLE_INDEX_STAR_MAP
