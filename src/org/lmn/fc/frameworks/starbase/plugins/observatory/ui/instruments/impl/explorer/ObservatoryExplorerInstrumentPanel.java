...
package org.lmn.fc.frameworks.starbase.plugins.observatory.ui.instruments.impl.explorer;
...
/***************************************************************************************************
 * The ObservatoryExplorerInstrumentPanel.
 */

public final class ObservatoryExplorerInstrumentPanel extends InstrumentUIComponentDecorator
    {
    // String Resources
    private static final String ICON_HEADER = "observatory-explorer-header.png";

    private static final String INSTRUMENT_HELP = "ObservatoryExplorerHelp.html";


    /***********************************************************************************************
     * Construct a ObservatoryExplorerInstrumentPanel.
     *
     * @param instrument
     * @param instrumentxml
     * @param hostui
    ...
    public ObservatoryExplorerInstrumentPanel(final ObservatoryInstrumentInterface instrument,
    ...
    /***********************************************************************************************
     * Initialise the ObservatoryExplorerInstrumentPanel.
     */
    ...
    public final void initialiseUI()
        ...
        // Create the ObservatoryExplorerInstrumentPanel and add it to the host UIComponent
    ...
    /* Utilities                                                                                  */
    /***********************************************************************************************
     * Create and initialise the JTabbedPane for the ObservatoryExplorerInstrumentPanel.
     */
    ...
    private void createAndInitialiseTabs()
        ...
        InstrumentPanelTabFactory.addSerialConfigurationTab(this,
                                                            TAB_SERIAL_CONFIGURATION,
                                                            REGISTRY_MODEL.getLoggedInUser());

        InstrumentPanelTabFactory.addNetworkScannerTab(this,
                                                       TAB_SCANNER,
                                                       REGISTRY_MODEL.getLoggedInUser());

        InstrumentPanelTabFactory.addAudioExplorerTab(this,
                                                      TAB_AUDIO_EXPLORER,
                                                      REGISTRY_MODEL.getLoggedInUser());

        InstrumentPanelTabFactory.addTimeZoneTab(this,
                                                 TAB_TIME_ZONES,
                                                 REGISTRY_MODEL.getLoggedInUser());
