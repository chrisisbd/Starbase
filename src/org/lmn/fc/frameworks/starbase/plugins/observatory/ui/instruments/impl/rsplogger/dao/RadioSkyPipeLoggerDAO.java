...
/***************************************************************************************************
 * CombinedRadioSkyPipeLoggerRxDAO.
 * Delivers data from a local RadioSkyPipe instance.
 */

public final class RadioSkyPipeLoggerDAO extends AbstractObservatoryInstrumentDAO
    ...
    /***********************************************************************************************
     * Construct a CombinedRadioSkyPipeLoggerRxDAO.
     *
     * @param hostinstrument
     */

    public RadioSkyPipeLoggerDAO(final ObservatoryInstrumentInterface hostinstrument)
        {
    ...
    public boolean initialiseDAO(final String resourcekey)
        ...
        LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                               "CombinedRadioSkyPipeLoggerRxDAO.initialiseDAO() [resourcekey=" + resourcekey + "]");
    ...
    public void disposeDAO()
        {
        LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                               "CombinedRadioSkyPipeLoggerRxDAO.disposeDAO()");
    ...
    public CommandMessageInterface constructCommandMessage(final ObservatoryInstrumentDAOInterface dao,
        ...
        {
        return (new RadioSkyPipeLoggerCommandMessage(dao,
                                                     instrumentxml,
                                                     module,
                                                     command,
                                                     starscript.trim()));
    ...
    public ResponseMessageInterface constructResponseMessage(final String portname,
        ...
        {
        return (new RadioSkyPipeLoggerResponseMessage(portname,
                                                      instrumentxml,
                                                      module,
                                                      command,
                                                      starscript.trim(),
    ...
    /***********************************************************************************************
     * Read all the Resources required by the CombinedRadioSkyPipeLoggerRxDAO.
     *
    ...
    public void readResources()
        {
        LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                               "CombinedRadioSkyPipeLoggerRxDAO.readResources() [ResourceKey=" + getResourceKey() + "]");
