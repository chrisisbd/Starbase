...
/***************************************************************************************************
 * ObservatoryInstallerCommandMessage.
 */

public final class ObservatoryInstallerCommandMessage
        extends AbstractCommandMessage
    {
    /***********************************************************************************************
     * Construct a ObservatoryInstallerCommandMessage.
    ...
    public ObservatoryInstallerCommandMessage(final ObservatoryInstrumentDAOInterface dao,
            ...
            if (command.getLegacyCode() != null)
                ...
                if (command.getParameterList().size() == 1)
                    ...
                    if ((parameter.getValue() != null)
                        ...
                        // Map the Parameter to a String appropriate to a ObservatoryInstallerCommandMessage
                        ...
                        if (strParameter != null)
                            ...
                            LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                                                   "ObservatoryInstallerCommandMessage.buildByteArray() [parameter="
                                                        + strParameter
                                                        + "] [datatype="
                            ...
                            LOGGER.error("ObservatoryInstallerCommandMessage.buildByteArray() Invalid ParameterValue");
                            }
                        }
                    else
                        {
                        // Something is wrong with the data we have been given
                        LOGGER.error("ObservatoryInstallerCommandMessage.buildByteArray() Invalid Parameter");
                        }
                    }
                else
                    {
                    LOGGER.error("ObservatoryInstallerCommandMessage.buildByteArray() Command has an incorrect number of Parameters");
                    }
                }
            else
                {
                LOGGER.error("ObservatoryInstallerCommandMessage.buildByteArray() Command does not have a LegacyCode");
                }
            }
        else
            {
