...
public final class GpsCommandMessage extends AbstractCommandMessage
    {
    /***********************************************************************************************
     * Construct a GpsCommandMessage.
    ...
    public GpsCommandMessage(final ObservatoryInstrumentDAOInterface dao,
            ...
            if (command.getLegacyCode() != null)
                ...
                if (command.getParameterList().size() == 1)
                    ...
                    if ((parameter.getValue() != null)
                        ...
                        // Map the Parameter to a String appropriate to a GpsCommandMessage
                        ...
                        if (strParameter != null)
                            ...
                            LOGGER.debugGpsEvent(true,
                                                 "GpsCommandMessage.buildByteArray() [parameter="
                                                    + strParameter
                                                    + "] [datatype="
                            ...
                            LOGGER.error("GpsCommandMessage.buildByteArray() Invalid ParameterValue");
                            }
                        }
                    else
                        {
                        // Something is wrong with the data we have been given
                        LOGGER.error("GpsCommandMessage.buildByteArray() Invalid Parameter");
                        }
                    }
                else
                    {
                    LOGGER.error("GpsCommandMessage.buildByteArray() Command has an incorrect number of Parameters");
                    }
                }
            else
                {
                LOGGER.error("GpsCommandMessage.buildByteArray() Command does not have a LegacyCode");
                }
            }
        else
            {
