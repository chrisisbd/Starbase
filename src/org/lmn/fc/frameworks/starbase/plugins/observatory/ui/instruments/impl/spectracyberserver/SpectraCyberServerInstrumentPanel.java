...
package org.lmn.fc.frameworks.starbase.plugins.observatory.ui.instruments.impl.spectracyberserver;
...
/***************************************************************************************************
 * The SpectraCyberServerInstrumentPanel.
 */

public final class SpectraCyberServerInstrumentPanel extends InstrumentUIComponentDecorator
    {
    // String Resources
    private static final String ICON_HEADER = "spectracyber-header.png";

    private static final String INSTRUMENT_HELP = "SpectraCyberServerHelp.html";


    /***********************************************************************************************
     * Construct a SpectraCyberServerInstrumentPanel.
     *
     * @param instrument
     * @param instrumentxml
     * @param oui
    ...
    public SpectraCyberServerInstrumentPanel(final ObservatoryInstrumentInterface instrument,
    ...
    /***********************************************************************************************
     * Initialise the SpectraCyberServerInstrumentPanel.
     */
    ...
    public final void initialiseUI()
        ...
        // Create the SpectraCyberServerInstrumentPanel and add it to the host UIComponent
    ...
    /* Utilities                                                                                  */
    /***********************************************************************************************
     * Create and initialise the JTabbedPane for the SpectraCyberServerInstrumentPanel.
     */
    ...
    public void instrumentChanged(final InstrumentStateChangedEvent event)
        ...
        if (event != null)
            ...
            LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                                   "SpectraCyberServerInstrumentPanel.instrumentChanged() --> " + event.getNextState().getName());
