...
public final class AudioExplorerCellRenderer extends DefaultTreeCellRenderer
    {
    private static final Logger LOGGER = Logger.getInstance();

    private static final long serialVersionUID = -3365995800432255646L;
    ...
    public AudioExplorerCellRenderer()
        {
        super();
        }
    ...
    public Component getTreeCellRendererComponent(final JTree tree,
                                                  ...
                                                  final boolean focus)
        {
        final String SOURCE = "AudioExplorerCellRenderer.getTreeCellRendererComponent() ";
            ...
            if (objectTreeNode != null)
                ...
                if (userObject != null)
                    ...
                    if (userObject instanceof AudioExplorerExpanderDataInterface)
                        {
                        final AudioExplorerExpanderDataInterface expanderData;

                        expanderData = (AudioExplorerExpanderDataInterface)userObject;
                        ...
                        {
                        final AudioExplorerLeafDataInterface leafData;

                        leafData = (AudioExplorerLeafDataInterface)userObject;
