...
/***************************************************************************************************
 * The StarinetTesterControlPanel.
 */

public final class StarinetTesterControlPanel extends InstrumentUIComponentDecorator
                                              implements ControlPanelInterface
    {
    // String Resources
    private static final String ICON_CONTROL = "starinet-tester-control.png";


    /***********************************************************************************************
     * Construct the StarinetTesterControlPanel.
     *
     * @param instrument
     * @param oui
     * @param instrumentxml
    ...
    public StarinetTesterControlPanel(final ObservatoryInstrumentInterface instrument,
    ...
    public void instrumentChanged(final InstrumentStateChangedEvent event)
        {
        LOGGER.debugIndicators("StarinetTesterControlPanel.instrumentChanged() --> update indicators");
    ...
    /* Utilities                                                                                  */
    /***********************************************************************************************
     *  Read all the Resources required by the StarinetTesterControlPanel.
     */

    public void readResources()
        {
        LOGGER.debugTimedEvent(LOADER_PROPERTIES.isTimingDebug(),
                               "StarinetTesterControlPanel [ResourceKey=" + getResourceKey() + "]");
        }
    }
