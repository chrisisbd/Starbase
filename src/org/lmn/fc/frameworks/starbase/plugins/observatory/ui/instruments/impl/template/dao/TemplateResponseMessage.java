...
public final class TemplateResponseMessage
        extends AbstractResponseMessage
    {
    /***********************************************************************************************
     * Construct a TemplateResponseMessage.
    ...
    public TemplateResponseMessage(final String portname,
...
//            && (XmlBeansUtilities.isValidXml(command))
    ...
    /***********************************************************************************************
     * Parse a byte array, attempting to find a TemplateResponseMessage
