...
public final class DiscoverEthernet implements FrameworkConstants,
                                               FrameworkStrings,
                                               FrameworkMetadata,
                                               FrameworkSingletons,
    ...
    public static ResponseMessageInterface doDiscoverEthernet(final ObservatoryInstrumentDAOInterface dao,
                                                              final CommandMessageInterface commandmessage)
        {
        final String SOURCE = "DiscoverEthernet.doDiscoverEthernet() ";
