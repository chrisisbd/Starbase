...
import org.lmn.fc.frameworks.starbase.plugins.workshop.ui.clock.ClockPanel;
...
public final class ClockTester extends TaskData
    {
    public static final Dimension DIM_CLOCK = new Dimension(140, 65);

    // String Resources
    private static final String STATUS_TESTER = "A Clock tester for";


    /***********************************************************************************************
     * Construct a ClockTester.
     */

    private ClockTester()
        {
        super(8235382642982205905L);
        }


    /***********************************************************************************************
     * Initialise the ClockTester Task.
     *
    ...
    public final boolean initialiseTask()
        {
        // Read the Resources for the ClockTester
        readResources();
    ...
    public final boolean runTask()
        ...
        // Remove any previous ClockTester
        ...
        setUIComponent(new ClockPanel(REGISTRY.getFramework(), DIM_CLOCK));
    ...
    /***********************************************************************************************
     * Shutdown the ClockTester after use.
     *
     * @return boolean flag indicating success or failure
     */
    ...
    /***********************************************************************************************
     * Read all the Resources required by the ClockTester.
     */
