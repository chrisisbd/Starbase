...
package org.lmn.fc.frameworks.starbase.plugins.workshop;
...
public final class Workshop extends PluginData
                            implements WorkshopMBean
    {
    /***********************************************************************************************
     * Construct Workshop.
     */
    ...
    public boolean startupAtom()
        ...
        if (super.startupAtom())
            {
            final ContextAction action0 = new ContextAction("Workshop Action",
                                                            null,
                                                            "Workshop Action",
                                                            KeyEvent.VK_W,
                                                            true,
                ...
                public void actionPerformed(final ActionEvent event)
                    {
                    System.out.println("Workshop Action - do nothing");
                    }
                };
    ...
    /***********************************************************************************************
     * Read all Resources required by Workshop.
     */
