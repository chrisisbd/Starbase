...
public class SunFixed
	 ...
	 */
	private static double geomMeanLongSun(double juliancenturies)
        {
		double dblLongitude;

        dblLongitude = 280.46646 + juliancenturies * (36000.76983 + 0.0003032 * juliancenturies);

        while (dblLongitude > 360.0)
            {
            dblLongitude -= 360.0;
            }

		while (dblLongitude < 0.0)
            {
            dblLongitude += 360.0;
            }
